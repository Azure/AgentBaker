...
#CONTAINER_RUNTIME={{GetParameter "containerRuntime"}} This variable is no longer required since we only support Containerd and Docker has been out of support for 1.5 years.
