...
replace (
	github.com/Azure/agentbaker/aks-node-controller => ./aks-node-controller
	github.com/coreos/ignition/v2 => github.com/flatcar/ignition/v2 v2.0.0-20250903113522-05b8a773288c
)
