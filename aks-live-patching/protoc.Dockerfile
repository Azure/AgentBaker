...
RUN set -e; \
    ...
    PROTOC_GEN_GO_GRPC_URL="https://github.com/grpc/grpc-go/releases/download/cmd/protoc-gen-go-grpc/v${PROTOC_GEN_GO_GRPC_VERSION}/protoc-gen-go-grpc.v${PROTOC_GEN_GO_GRPC_VERSION}.linux.amd64.tar.gz"; \
    ...
    PROTOC_GEN_GO_GRPC_URL="https://github.com/grpc/grpc-go/releases/download/cmd/protoc-gen-go-grpc/v${PROTOC_GEN_GO_GRPC_VERSION}/protoc-gen-go-grpc.v${PROTOC_GEN_GO_GRPC_VERSION}.linux.arm64.tar.gz"; \
    else \
    ...
    \
    # Download and install protobuf Go gRPC plugin
    wget -O protoc-gen-go-grpc.tar.gz $PROTOC_GEN_GO_GRPC_URL; \
    tar -xzf protoc-gen-go-grpc.tar.gz -C /usr/local/bin; \
    rm protoc-gen-go-grpc.tar.gz
