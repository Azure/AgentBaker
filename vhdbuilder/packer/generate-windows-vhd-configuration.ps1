...
$global:map = @{
    ...
    "c:\akse-cache\win-k8s\"      = @(
        ...
        "https://acs-mirror.azureedge.net/kubernetes/v1.19.13/windowszip/v1.19.13-hotfix.20210830-1int.zip",
        ...
        "https://acs-mirror.azureedge.net/kubernetes/v1.20.9/windowszip/v1.20.9-hotfix.20210830-1int.zip",
