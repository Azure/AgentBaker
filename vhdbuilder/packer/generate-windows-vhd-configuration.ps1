...
$global:patchUrls = @("http://download.windowsupdate.com/c/msdownload/update/software/secu/2021/08/windows10.0-kb5005030-x64_222160abfb75f543a693ca773dbcd0553ace6f03.msu")
$global:patchIDs = @("KB5005030")
...
$global:map = @{
    "c:\akse-cache\"              = @(
        ...
        "https://acs-mirror.azureedge.net/ccgakvplugin/v1.1.0/binaries/windows-gmsa-ccgakvplugin-v1.1.0.zip"
    );
    ...
    "c:\akse-cache\win-k8s\"      = @(
        ...
        "https://acs-mirror.azureedge.net/kubernetes/v1.21.2-hotfix.20210816/windowszip/v1.21.2-hotfix.20210816"
    );
    "c:\akse-cache\win-vnet-cni\" = @(
        ...
        "https://acs-mirror.azureedge.net/azure-cni/v1.4.7/binaries/azure-vnet-cni-singletenancy-windows-amd64-v1.4.7.zip"
    );
    "c:\akse-cache\calico\" = @(
