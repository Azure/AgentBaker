...
downloadGPUDrivers
retrycmd_if_failure 30 5 3600 wget "https://developer.download.nvidia.com/compute/cuda/redist/fabricmanager/linux-x86_64/fabricmanager-linux-x86_64-${GPU_DV}.tar.xz" || exit $ERR_GPU_DOWNLOAD_TIMEOUT
