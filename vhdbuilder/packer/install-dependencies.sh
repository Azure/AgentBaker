...
# /opt/azure/containers/akslocaldns/<corednsImageTag>/coredns. The binary is later used by akslocaldns systemd unit.
...
extractAndCacheCoreDNSBinaries() {
  ...
  # /opt/azure/containers/akslocaldns/<corednsImageTag>/coredns.
  local dest_path="/opt/azure/containers/akslocaldns"
  mkdir -p "${dest_path}"
