...
#Benchmark 11 End
#Benchmark 12 Start
record_benchmark 'Configure telemetry, create logging directory, kube-proxy Start'
start_watch
...
for KUBE_PROXY_IMAGE_VERSION in ${KUBE_PROXY_IMAGE_VERSIONS}; do
  ...
  PIDS1+=($!) # append the process ID to the array
...
record_benchmark 'Configure telemetry, create logging directory, kube-proxy End'
