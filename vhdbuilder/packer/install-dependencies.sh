...
stop_watch $capture_time "Declare Variables / Configure Environment"
start_watch
...
stop_watch $capture_time "Purge and Re-install Ubuntu"
start_watch
...
ForwardToSyslog=yes
EOF
stop_watch $capture_time "Install Dependencies"
start_watch
...
stop_watch $capture_time "Check Container Runtime / Network Configurations"
start_watch
...
stop_watch $capture_time "Create Containerd Service Directory, Download Shims, Configure Runtime and Network"
start_watch
...
stop_watch $capture_time "Download Components, Determine / Download crictl Version"
start_watch
...
stop_watch $capture_time "Artifact Streaming, Download Containerd Plugins"
start_watch
...
echo "install Bcc start"
installBcc
cat << EOF >> ${VHD_LOGS_FILEPATH}
  - bcc-tools
  - libbcc-examples
EOF
echo "install Bcc End"

echo "${CONTAINER_RUNTIME} images pre-pulled:" >> ${VHD_LOGS_FILEPATH}
stop_watch $capture_time "Pull NVIDIA Image, Install BCC"
start_watch
...
stop_watch $capture_time "Pull and Re-tag Container Images"
start_watch
...
stop_watch $capture_time "Configure Networking and Interface"
start_watch
...
stop_watch $capture_time "GPU Device plugin"
start_watch
...
stop_watch $capture_time "Configure Telemetry, Create Logging Directory, Kube-proxy"
start_watch
...
stop_watch $capture_time "Download and Process Kubernetes Packages / Extract Binaries"
stop_watch $script_start_time "install-dependencies.sh"
show_benchmarks
