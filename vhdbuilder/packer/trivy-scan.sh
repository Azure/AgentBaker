...
retrycmd_if_failure 10 60 600 ./trivy --ignore-unfixed --scanners vuln rootfs --skip-dirs /var/lib/containerd --severity ${SEVERITY} -f json -o "${TRIVY_REPORT_ROOTFS_JSON_PATH}" /
