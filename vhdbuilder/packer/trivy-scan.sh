...
TRIVY_DEB_2004_VERSION="0.70.0-ubuntu20.04u7"

# renovate: datasource=custom.deb2204 depName=trivy versioning=deb
TRIVY_DEB_2204_VERSION="0.70.0-ubuntu22.04u7"

# renovate: datasource=custom.deb2404 depName=trivy versioning=deb
TRIVY_DEB_2404_VERSION="0.70.0-ubuntu24.04u7"
...
TRIVY_RPM_VERSION="0.70.0-6.azl3"
