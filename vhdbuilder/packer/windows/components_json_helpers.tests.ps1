...
Describe 'Tests of components-test.json ' {
    ...
    It 'has containerd 2.0 versions for 2025' {
        $windowsSku = "2025"

        $packages = GetPackagesFromComponentsJson $componentsJson

        $packages["c:\akse-cache\containerd\"] | Should -Contain "https://packages.aks.azure.com/containerd/windows/v2.0.4-azure.1/binaries/containerd-v2.0.4-azure.1-windows-amd64.tar.gz"
        $packages["c:\akse-cache\containerd\"] | Should -Not -Contain "https://packages.aks.azure.com/containerd/windows/v1.7.20-azure.1/binaries/containerd-v1.7.20-azure.1-windows-amd64.tar.gz"
        $packages["c:\akse-cache\containerd\"] | Should -Not -Contain "https://packages.aks.azure.com/containerd/windows/v1.6.35-azure.1/binaries/containerd-v1.6.35-azure.1-windows-amd64.tar.gz"
    }

    It 'has containerd 2.0 versions for 2025-gen2' {
        $windowsSku = "2025-gen2"
    ...
    it 'has the right default containerd 2.0 runtime for ws2025' {
        $windowsSku = "2025"

        $containerDUrl = GetDefaultContainerDFromComponentsJson $componentsJson

        $containerDUrl | Should -Be "https://packages.aks.azure.com/containerd/windows/v2.0.4-azure.1/binaries/containerd-v2.0.4-azure.1-windows-amd64.tar.gz"
    }
}
