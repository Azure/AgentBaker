                ...
                try {
                    ...
                    if ($localFileSize -ne $remoteFileSize) {
                        $excludeHashComparisionListInAzureChinaCloud = @(
                            ...
                            "azure-vnet-cni-singletenancy-windows-amd64-v1.5.3.zip",
                            "azure-vnet-cni-singletenancy-windows-amd64-v1.5.4.zip",
                            "azure-vnet-cni-singletenancy-overlay-windows-amd64-v1.4.35_Win2019OverlayFix.zip",
                            "azure-vnet-cni-singletenancy-overlay-windows-amd64-v1.5.3.zip",
                            "azure-vnet-cni-singletenancy-overlay-windows-amd64-v1.5.4.zip",
