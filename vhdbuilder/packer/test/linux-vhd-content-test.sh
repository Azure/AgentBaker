#!/bin/bash
# Put this helper here so it's usable by the script itself, not just within functions.
err() {
...
#
# Strategy is to clone the repo, fetch the remove branch by ref into a local branch, and then checkout the local branch.
