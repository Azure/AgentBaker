...
echo "TEST_VM_ADMIN_USERNAME: $TEST_VM_ADMIN_USERNAME"
echo "ARCHITECTURE: $ARCHITECTURE"
echo "TRIVY_REPORT_NAME: $TRIVY_REPORT_NAME"
echo "TRIVY_TABLE_NAME: $TRIVY_TABLE_NAME"
echo "SIG_CONTAINER_NAME: $SIG_CONTAINER_NAME"
echo "STORAGE_ACCOUNT_NAME: $STORAGE_ACCOUNT_NAME"
echo "ENABLE_TRUSTED_LAUNCH: $ENABLE_TRUSTED_LAUNCH"
echo "STORAGE_REPORT_FILE_NAME: $STORAGE_REPORT_FILE_NAME"
