...
if [ ! -z "${WINDOWS_SKU}" ]; then
	...
	case "${WINDOWS_SKU}" in
	"2019") 
		WINDOWS_IMAGE_SKU=$WINDOWS_IMAGE_2019_SKU
		WINDOWS_IMAGE_VERSION=$WINDOWS_IMAGE_2019_VERSION
		;;
	"2004")
		WINDOWS_IMAGE_SKU=$WINDOWS_IMAGE_2004_SKU
		WINDOWS_IMAGE_VERSION=$WINDOWS_IMAGE_2004_VERSION
		;;
	*)  
