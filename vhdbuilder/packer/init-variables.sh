...
echo "AZURE_VM_SIZE is set to $AZURE_VM_SIZE"
...
echo "BUILD_DEFINITION_NAME is set to $BUILD_DEFINITION_NAME"
...
echo "TELEPORTD_PLUGIN_DOWNLOAD_URL is set to $TELEPORTD_PLUGIN_DOWNLOAD_URL"
...
echo "PRIVATE_PACKAGES_URL is set to $PRIVATE_PACKAGES_URL"
