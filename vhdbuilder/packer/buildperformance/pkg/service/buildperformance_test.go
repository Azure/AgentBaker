...
func TestParseKustoData(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			expected: map[string]map[string][2]float64{
				"pre_install_dependencies": {
					"copy_packer_files":                                                [2]float64{30.0, 20},
					"sync_container_logs":                                              [2]float64{30.0, 20},
					"handle_mariner_and_fips_configurations":                           [2]float64{30.0, 20},
					"handle_azureLinux_and_cgroupV2":                                   [2]float64{30.0, 20},
					"enable_modified_log_rotate_service":                               [2]float64{15.0, 10.0},
					"make_directory_and_update_certs":                                  [2]float64{30.0, -1},
					"start_system_logs_and_aks_log_collector":                          [2]float64{30.0, 20},
					"pre_install_dependencies_overall":                                 [2]float64{30.0, 20},
					"source_packer_files_declare_variables_and_set_mariner_permission": [2]float64{30.0, 20},
				},
				"install_dependencies": {
					"download_runc": [2]float64{30.0, 20},
					"create_containerd_service_directory_download_shims_configure_runtime_and_network": [2]float64{30.0, 20},
					"configure_telemetry_create_logging_directory":                                     [2]float64{30.0, 20},
					"pull_nvidia_driver_image_and_run_installBcc_in_subshell":                          [2]float64{30.0, 20},
					"download_azure_cni":                                 [2]float64{15.0, 10.0},
					"download_gpu_device_plugin":                         [2]float64{30.0, 20},
					"download_kubernetes_binaries":                       [2]float64{30.0, 20},
					"declare_variables_and_source_packer_files":          [2]float64{30.0, 20},
					"download_containerd":                                [2]float64{30.0, 20},
					...
					"install_dependencies_overall":                       [2]float64{30.0, 20},
					"check_container_runtime_and_network_configurations": [2]float64{30.0, 20},
					"download_oras":                                      [2]float64{30.0, 20},
					"install_dependencies":                               [2]float64{30.0, 20},
					"download_cni_plugins":                               [2]float64{30.0, 20},
				},
				"post_install_dependencies": {
					"resolve_conf":                          [2]float64{15.0, 10.0},
					"post_install_dependencies_overall":     [2]float64{30.0, 20},
					"set_variables_and_source_packer_files": [2]float64{30.0, 20},
					"log_and_detach_ua":                     [2]float64{30.0, 20},
					"determine_disk_usage":                  [2]float64{30.0, 20},
					"install_asc_baseline":                  [2]float64{30.0, 20},
					"write_logs":                            [2]float64{30.0, 20},
					"list_installed_packages":               [2]float64{30.0, 20},
				},
			},
		},
	}
