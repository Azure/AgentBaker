...
copyPackerFiles() {
  ...
  cpAndMode $CGROUP_STATS_SERVICE_SRC $CGROUP_STATS_SERVICE_DEST 644
  cpAndMode $CGROUP_STATS_SCRIPT_SRC $CGROUP_STATS_SCRIPT_DEST 755
  cpAndMode $CGROUP_STATS_TIMER_SRC $CGROUP_STATS_TIMER_DEST 644
