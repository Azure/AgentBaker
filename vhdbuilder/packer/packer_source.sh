...
copyPackerFiles() {
  ...
  CGROUP_MEMORY_TELEMETRY_SCRIPT_DEST=/etc/systemd/system/cgroup-memory-telemetry.timer
  ...
  CGROUP_PRESSURE_TELEMETRY_SCRIPT_DEST=/etc/systemd/system/cgroup-pressure-telemetry.timer
