...
copyPackerFiles() {
  ...
  UPDATE_KUBELET_NODE_LABELS_SRC=/home/packer/update-kubelet-node-labels.sh
  UPDATE_KUBELET_NODE_LABELS_DEST=/opt/azure/containers/update-kubelet-node-labels.sh
...
# ---------------------------------------------------------------------------------------
  ...
  cpAndMode $UPDATE_KUBELET_NODE_LABELS_SRC $UPDATE_KUBELET_NODE_LABELS_DEST 755
