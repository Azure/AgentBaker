...
copyPackerFiles() {
  ...
  CUSTOM_CA_RESTART_CONTAINERD_SCRIPT_SRC=/home/packer/restart_containerd.sh
  CUSTOM_CA_RESTART_CONTAINERD_SCRIPT_DEST=/opt/scripts/restart_containerd.sh
  UPDATE_CERTS_PROVISIONING_SERVICE_SRC=/home/packer/update_certs_provisioning.service
  UPDATE_CERTS_PROVISIONING_SERVICE_DEST=/etc/systemd/system/update_certs_provisioning.service
  ...
  cpAndMode $CUSTOM_CA_RESTART_CONTAINERD_SCRIPT_SRC $CUSTOM_CA_RESTART_CONTAINERD_SCRIPT_DEST 755
  cpAndMode $UPDATE_CERTS_PROVISIONING_SERVICE_SRC $UPDATE_CERTS_PROVISIONING_SERVICE_DEST 644
