...
copyPackerFiles() {
  ...
  CACHER_BINARY_SRC=/home/packer/cacher
  CACHER_BINARY_DEST=/opt/azure/containers/cacher
  ...
  # Copy cacher binary to the appropriate location
  cpAndMode $CACHER_BINARY_SRC $CACHER_BINARY_DEST 744
}
