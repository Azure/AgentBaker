...
copyPackerFiles() {
  ...
  AZURE_NETWORK_TUNING_SCRIPT_SRC=/home/packer/azure-network-tuning.sh
  AZURE_NETWORK_TUNING_SCRIPT_DEST=/opt/azure-network/azure-network-tuning.sh
...
# ---------------------------------------------------------------------------------------
  ...
  cpAndMode $AZURE_NETWORK_TUNING_SCRIPT_SRC $AZURE_NETWORK_TUNING_SCRIPT_DEST 755
