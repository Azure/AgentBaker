...
copyPackerFiles() {
  ...
  AKS_CHECK_NETWORK_SRC=/home/packer/aks-check-network.sh.sh
  AKS_CHECK_NETWORK_DEST=/usr/local/bin/aks-check-network.sh.sh
  AKS_CHECK_NETWORK_SERVICE_SRC=/home/packer/aks-check-network.sh.service
  AKS_CHECK_NETWORK_SERVICE_DEST=/etc/systemd/system/aks-check-network.sh.service
  ...
  cpAndMode $AKS_CHECK_NETWORK_SRC $AKS_CHECK_NETWORK_DEST 755
