...
installBcc() {
    ...
    apt_get_install 120 5 300 build-essential git bison cmake flex  libedit-dev libllvm8.0 llvm-8.0-dev libclang-8.0-dev python zlib1g-dev libelf-dev || exit $ERR_BCC_INSTALL_TIMEOUT
    ...
    apt_get_purge 120 5 300 bison cmake flex libedit-dev libllvm8.0 llvm-8.0-dev libclang-8.0-dev zlib1g-dev libelf-dev || exit $ERR_BCC_INSTALL_TIMEOUT
    if [ "$VERSION" = "18.04" ]; then
