...
prefetch "mcr.microsoft.com/containernetworking/azure-cni:v1.6.11" "/dropgz"
...
prefetch "mcr.microsoft.com/containernetworking/azure-cns:v1.6.11" "/usr/local/bin/azure-cns"
