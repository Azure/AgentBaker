...
AKSLOCALDNS_ENV_FILE="/etc/default/akslocaldns.envfile"
...
AKSLOCALDNS_CORE_FILE="/opt/azure/containers/akslocaldns/akslocaldns.corefile"
...
: "${AKSLOCALDNS_IMAGE_TAG:?AKSLOCALDNS_IMAGE_TAG is not set}"
...
# --------------------------------------------------------------------------------------------------------------------
AKSLOCALDNS_SCRIPT_PATH="/opt/azure/containers/akslocaldns"

# Coredns binary is extracted from cached coredns image(s) and pre-installed in the VHD -
# /opt/azure/containers/akslocaldns/<version>/coredns.
COREDNS_BINARY_PATH="${AKSLOCALDNS_SCRIPT_PATH}/${AKSLOCALDNS_IMAGE_TAG}/coredns"
