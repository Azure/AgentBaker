...
if [ "$NVIDIA_GPU_DRIVER_TYPE" = "cuda-lts" ]; then
  # TEST ONLY: exercise the aks-gpu CDI-ordering candidate on the node.
  export NVIDIA_DRIVER_IMAGE="gpucditest0730165750.azurecr.io/aks-gpu-cuda-lts"
  export NVIDIA_DRIVER_IMAGE_TAG="580.159.04-20260730165836"
fi
