...
echo "CSE variable: SHOULD_ENABLE_LOCALDNS=${SHOULD_ENABLE_LOCALDNS}, SHOULD_ENABLE_HOSTS_PLUGIN=${SHOULD_ENABLE_HOSTS_PLUGIN}"
...
LOCALDNS_GENERATED_COREFILE_NO_HOSTS="{{GetGeneratedLocalDNSCoreFileNoHosts}}"
