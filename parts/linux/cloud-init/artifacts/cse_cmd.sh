...
HTTP_PROXY_TRUSTED_CA={{ShellQuote GetHTTPProxyCA}}
...
HTTP_PROXY_URLS={{ShellQuote GetHTTPProxy}}
HTTPS_PROXY_URLS={{ShellQuote GetHTTPSProxy}}
NO_PROXY_URLS={{ShellQuote GetNoProxy}}
PROXY_VARS={{ShellQuote GetProxyVariables}}
