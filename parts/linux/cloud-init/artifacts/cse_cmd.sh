...
AKS_LOCAL_DNS_GENERATED_COREFILE="{{GetAKSLocalDNSGeneratedCoreFile}}"
AKS_LOCAL_DNS_IMAGE_URL="{{GetAKSLocalDNSImageUrl}}"
AKS_LOCAL_DNS_NODE_LISTENER_IP="{{GetAKSLocalDNSNodeListenerIP}}"
AKS_LOCAL_DNS_CLUSTER_LISTENER_IP="{{GetAKSLocalDNSClusterListenerIP}}"
AKS_LOCAL_DNS_CPU_LIMIT="{{GetAKSLocalDNSCPULimit}}"
AKS_LOCAL_DNS_MEMORY_LIMIT="{{GetAKSLocalDNSMemoryLimit}}"
