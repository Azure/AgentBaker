...
IS_AKSLOCALDNS_ENABLED="{{IsAKSLocalDNSEnabled}}"
AKSLOCALDNS_GENERATED_COREFILE="{{GetAKSLocalDNSGeneratedCoreFile}}"
AKSLOCALDNS_IMAGE_URL="{{GetAKSLocalDNSImageUrl}}"
AKSLOCALDNS_NODE_LISTENER_IP="{{GetAKSLocalDNSNodeListenerIP}}"
AKSLOCALDNS_CLUSTER_LISTENER_IP="{{GetAKSLocalDNSClusterListenerIP}}"
AKSLOCALDNS_CPU_LIMIT="{{GetAKSLocalDNSCPULimit}}"
AKSLOCALDNS_MEMORY_LIMIT="{{GetAKSLocalDNSMemoryLimit}}"
