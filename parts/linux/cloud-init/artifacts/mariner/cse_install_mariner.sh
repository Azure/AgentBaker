...
installKataDeps() {
    if [[ $OS_VERSION == "2.0" ]]; then
      ...
      wget "https://mitchzhu.blob.core.windows.net/public/mshv-linuxloader-0.5.0-2.1.cm2.x86_64.rpm" -O mshv-linuxloader-0.5.0-2.1.cm2.x86_64.rpm
