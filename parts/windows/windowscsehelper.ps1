...
$global:WINDOWS_CSE_ERROR_START_SECURE_TLS_BOOTSTRAP_SERVICE=72 # exit code for starting secure TLS bootstrap service failure
...
$global:ErrorCodeNames = @(
    ...
    "WINDOWS_CSE_ERROR_START_SECURE_TLS_BOOTSTRAP_SERVICE"
)
