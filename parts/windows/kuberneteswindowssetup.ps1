...
try
{
    ...
    $WindowsCSEScriptsPackage = "aks-windows-cse-scripts-v0.0.48.zip"
    ...
    {
        Write-Log "Not writing bootstrap kube config as no bootstrap token present"
    }

    if ($global:AgentCertificate)
    {
        ...
        Write-Log "Write kube config based on agent certificate"
    }
    else
    {
        Write-Log "Not writing kube config as no agent certificate present"
    }
