...
PowerShell -File $outputFile -AADClientSecret ''{{ GetParameter "encodedServicePrincipalClientSecret" }}'' -CSEResultFilePath %SYSTEMDRIVE%\AzureData\provision.complete >> %SYSTEMDRIVE%\AzureData\CustomDataSetupScript.log 2>&1;
