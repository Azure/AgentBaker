function Install-VnetPlugins
{
    ...
    DownloadFileOverHttp -Url $VNetCNIPluginsURL -DestinationPath $zipfile -ErrorCode $global:WINDOWS_CSE_ERROR_DOWNLOAD_CNI_PACKAGE
...
function Get-HnsPsm1
{
    ...
    DownloadFileOverHttp -Url $HnsUrl -DestinationPath "$HNSModule" -ErrorCode $global:WINDOWS_CSE_ERROR_DOWNLOAD_HNS_MODULE
}
