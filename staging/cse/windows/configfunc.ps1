...
function Install-GmsaPlugin {
    ...
    DownloadFileOverHttp -Url $GmsaPackageUrl -DestinationPath $tempPluginZipFile -ErrorCode $global:WINDOWS_CSE_ERROR_DOWNLOAD_GMSA_PACKAGE
...
function New-CsiProxyService {
    ...
    DownloadFileOverHttp -Url $CsiProxyPackageUrl -DestinationPath $binaryPackage -ErrorCode $global:WINDOWS_CSE_ERROR_DOWNLOAD_CSI_PROXY_PACKAGE
