...
run-packer: az-login
	@bash ./vhdbuilder/packer/init-azure-plugin.sh && packer version && ($(MAKE) -f packer.mk init-packer | tee packer-output) && ($(MAKE) -f packer.mk build-packer | tee -a packer-output)
