...
init-packer:
	$(call retrycmd_if_failure,2,3,900,./vhdbuilder/packer/init-variables.sh)
...
cleanup: az-login
	$(call retrycmd_if_failure, 2, 3, 600, ./vhdbuilder/packer/cleanup.sh)
...
test-building-vhd: az-login
	$(call retrycmd_if_failure, 2, 3, 900, ./vhdbuilder/packer/test/run-test.sh)

scanning-vhd: az-login
	$(call retrycmd_if_failure, 2, 3, 900, ./vhdbuilder/packer/vhd-scanning.sh)
