...
ifeq (${OS_SKU},Ubuntu)
	...
	@PACKER_LOG=1 packer build -timestamp-ui  -var-file=vhdbuilder/packer/settings.json vhdbuilder/packer/vhd-image-builder-mariner-arm64.json
...
ifeq ($(findstring cvm,$(FEATURE_FLAGS)),cvm)
	...
	@PACKER_LOG=1 packer build -timestamp-ui  -var-file=vhdbuilder/packer/settings.json vhdbuilder/packer/vhd-image-builder-mariner.json
else ifeq (${OS_SKU},AzureLinux)
ifeq ($(findstring cvm,$(FEATURE_FLAGS)),cvm)
