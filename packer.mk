...
ifeq (${OS_SKU},Ubuntu)
	@echo "Using packer template file vhd-image-builder-ubuntu-arm64-gen2.json"
	@packer build -var-file=vhdbuilder/packer/settings.json vhdbuilder/packer/vhd-image-builder-ubuntu-arm64-gen2.json
...
ifeq (${OS_SKU},Ubuntu)
	@echo "Using packer template file: vhd-image-builder-ubuntu.json"
	@packer build -var-file=vhdbuilder/packer/settings.json vhdbuilder/packer/vhd-image-builder-ubuntu.json
else ifeq (${OS_SKU},CBLMariner)
