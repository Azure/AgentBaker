...
ifeq (${MODE},gen2Mode)
	...
	@echo "${MODE}: Building with Hyper-v generation 1 minimal VM and save to Classic Storage Account"
	@packer build -var-file=vhdbuilder/packer/settings.json vhdbuilder/packer/vhd-image-builder-minimal.json
endif
