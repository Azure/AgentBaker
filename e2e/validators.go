...
// validateLocalDNSCorefileRegeneration is a shared validator function that tests localdns corefile
// regeneration capability across different distros.
...
`
	...
	ValidateLocalDNSResolution(ctx, s, "169.254.20.10")
