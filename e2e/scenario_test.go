...
func Test_AzureLinuxV2_ARM64(t *testing.T) {
	RunScenario(t, &Scenario{
		...
		Config: Config{
			...
			BootstrapConfigMutator: func(nbc *datamodel.NodeBootstrappingConfiguration) {
				nbc.ContainerService.Properties.OrchestratorProfile.KubernetesConfig.CustomKubeBinaryURL = "https://acs-mirror-euadb5gkdbg5c7f6.z01.azurefd.net/kubernetes/v1.24.9/binaries/kubernetes-node-linux-arm64.tar.gz"
