...
func Scenario_azurelinuxv2ARM64(t *testing.T) {
	RunScenario(t, &Scenario{
		...
		Config: Config{
			...
			BootstrapConfigMutator: func(nbc *datamodel.NodeBootstrappingConfiguration) {
				nbc.ContainerService.Properties.AgentPoolProfiles[0].VMSize = "Standard_D2pds_V3"
				...
				nbc.AgentPoolProfile.VMSize = "Standard_D2pds_V3"
				nbc.AgentPoolProfile.Distro = "aks-azurelinux-v2-arm64-gen2"
				nbc.IsARM64 = true
			},
			VMConfigMutator: func(vmss *armcompute.VirtualMachineScaleSet) {
				vmss.SKU.Name = to.Ptr("Standard_D2pds_V3")
			},
		},
	})
}
