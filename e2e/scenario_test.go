...
func Test_AzureLinuxV2_ARM64(t *testing.T) {
	RunScenario(t, &Scenario{
		...
		Config: Config{
			...
			BootstrapConfigMutator: func(nbc *datamodel.NodeBootstrappingConfiguration) {
				nbc.ContainerService.Properties.OrchestratorProfile.KubernetesConfig.CustomKubeBinaryURL = "https://packages.aks.azure.com/kubernetes/v1.24.9/binaries/kubernetes-node-linux-arm64.tar.gz"
...
func Test_AzureLinuxV2_ARM64_Scriptless(t *testing.T) {
	RunScenario(t, &Scenario{
		...
		Config: Config{
			...
			VHD:     config.VHDAzureLinuxV2Gen2Arm64,
			AKSNodeConfigMutator: func(config *aksnodeconfigv1.Configuration) {
				config.KubeBinaryConfig.CustomKubeBinaryUrl = "https://packages.aks.azure.com/kubernetes/v1.24.9/binaries/kubernetes-node-linux-arm64.tar.gz"
