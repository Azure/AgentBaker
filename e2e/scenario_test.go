...
// func Test_ubuntu2204KubeletStartsOnce(t *testing.T) {
// 	RunScenario(t, &Scenario{
// 		Description: "Tests the kubelet starts only once (and not restarted) when a GPU node is bootstrapped",
// 		Config: Config{
// 			Cluster: ClusterKubenet,
// 			VHD:     config.VHDUbuntu2204Gen2Containerd,
// 			BootstrapConfigMutator: func(nbc *datamodel.NodeBootstrappingConfiguration) {
...
// 			FileExcludesContentsValidator("/var/log/messages", "Stopping Kubelet"),
// 		}
// 	})
// }
