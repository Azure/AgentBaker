	...
	config := &datamodel.NodeBootstrappingConfiguration{
			...
			Properties: &datamodel.Properties{
				...
				OrchestratorProfile: &datamodel.OrchestratorProfile{
					...
					KubernetesConfig: &datamodel.KubernetesConfig{
						...
						CustomKubeBinaryURL:               fmt.Sprintf("https://acs-mirror-euadb5gkdbg5c7f6.z01.azurefd.net/kubernetes/v%s/binaries/kubernetes-node-linux-amd64.tar.gz", k8sVersion),
						MobyVersion:                       "",
						ContainerdVersion:                 "",
						...
						AzureCNIURLLinux:                  "https://acs-mirror-euadb5gkdbg5c7f6.z01.azurefd.net/azure-cni/v1.1.8/binaries/azure-vnet-cni-linux-amd64-v1.1.8.tgz",
		...
		CloudSpecConfig: &datamodel.AzureEnvironmentSpecConfig{
			...
			KubernetesSpecConfig: datamodel.KubernetesSpecConfig{
				...
				EtcdDownloadURLBase:                  "",
				KubeBinariesSASURLBase:               "https://acs-mirror-euadb5gkdbg5c7f6.z01.azurefd.net/kubernetes/",
				WindowsTelemetryGUID:                 "fb801154-36b9-41bc-89c2-f4d4f05472b0",
				CNIPluginsDownloadURL:                "https://acs-mirror-euadb5gkdbg5c7f6.z01.azurefd.net/cni/cni-plugins-amd64-v0.7.6.tgz",
				VnetCNILinuxPluginsDownloadURL:       "https://acs-mirror-euadb5gkdbg5c7f6.z01.azurefd.net/azure-cni/v1.1.3/binaries/azure-vnet-cni-linux-amd64-v1.1.3.tgz",
				VnetCNIWindowsPluginsDownloadURL:     "https://acs-mirror-euadb5gkdbg5c7f6.z01.azurefd.net/azure-cni/v1.1.3/binaries/azure-vnet-cni-singletenancy-windows-amd64-v1.1.3.zip",
				ContainerdDownloadURLBase:            "https://storage.googleapis.com/cri-containerd-release/",
				CSIProxyDownloadURL:                  "https://acs-mirror-euadb5gkdbg5c7f6.z01.azurefd.net/csi-proxy/v0.1.0/binaries/csi-proxy.tar.gz",
				WindowsProvisioningScriptsPackageURL: "https://acs-mirror-euadb5gkdbg5c7f6.z01.azurefd.net/aks-engine/windows/provisioning/signedscripts-v0.2.2.zip",
				WindowsPauseImageURL:                 "mcr.microsoft.com/oss/kubernetes/pause:1.4.0",
				AlwaysPullWindowsPauseImage:          false,
				CseScriptsPackageURL:                 "https://acs-mirror-euadb5gkdbg5c7f6.z01.azurefd.net/aks/windows/cse/csescripts-v0.0.1.zip",
				CNIARM64PluginsDownloadURL:           "https://acs-mirror-euadb5gkdbg5c7f6.z01.azurefd.net/cni-plugins/v0.8.7/binaries/cni-plugins-linux-arm64-v0.8.7.tgz",
				VnetCNIARM64LinuxPluginsDownloadURL:  "https://acs-mirror-euadb5gkdbg5c7f6.z01.azurefd.net/azure-cni/v1.4.13/binaries/azure-vnet-cni-linux-arm64-v1.4.14.tgz",
			},
		...
		ContainerService: &datamodel.ContainerService{
			Properties: &datamodel.Properties{
				...
				OrchestratorProfile: &datamodel.OrchestratorProfile{
					...
					KubernetesConfig: &datamodel.KubernetesConfig{
						AzureCNIURLWindows:   "https://acs-mirror-euadb5gkdbg5c7f6.z01.azurefd.net/azure-cni/v1.4.35/binaries/azure-vnet-cni-singletenancy-windows-amd64-v1.4.35.zip",
						...
						WindowsContainerdURL: "https://acs-mirror-euadb5gkdbg5c7f6.z01.azurefd.net/containerd/windows/",
					},
				},
				AgentPoolProfiles: []*datamodel.AgentPoolProfile{
					{
				...
				WindowsProfile: &datamodel.WindowsProfile{
					...
					CSIProxyURL:                    "https://acs-mirror-euadb5gkdbg5c7f6.z01.azurefd.net/csi-proxy/v0.2.2/binaries/csi-proxy-v0.2.2.tar.gz",
...
DXRqvV7TWO2hndliQq3BW385ZkiephlrmpUVM= r2k1@arturs-mbp.lan`,
		...
		K8sComponents: &datamodel.K8sComponents{
			WindowsPackageURL: fmt.Sprintf("https://acs-mirror-euadb5gkdbg5c7f6.z01.azurefd.net/kubernetes/v%s/windowszip/v%s-1int.zip", kubernetesVersion, kubernetesVersion),
		},
		AgentPoolProfile: &datamodel.AgentPoolProfile{
			Name:                "winnp",
			OSType:              "Windows",
