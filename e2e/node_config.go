				...
				AgentPoolProfiles: []*datamodel.AgentPoolProfile{
					{
						...
						LocalDNSProfile: &datamodel.LocalDNSProfile{
							...
							CriticalFQDNs: []string{
								...
								"packages.aks.azure.com",
								"westus.onlinects.speech.microsoft.com",
								"eastus.onlinects.speech.microsoft.com",
								"westeurope.onlinects.speech.microsoft.com",
								"southeastasia.onlinects.speech.microsoft.com",
								"transcribe.teams.eastus.cts.speech.microsoft.com",
								"transcribe.teams.westus.cts.speech.microsoft.com",
								"transcribe.teams.westcentralus.cts.speech.microsoft.com",
								"northeurope.onlinects.speech.microsoft.com",
								"transcribe.teams.westeurope.cts.speech.microsoft.com",
								"transcribe.teams.eastasia.cts.speech.microsoft.com",
								"northeurope.onlinectseui.speech.microsoft.com",
								"transcribe.teams.northeurope.cts.speech.microsoft.com",
