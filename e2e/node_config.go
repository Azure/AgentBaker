...
func nbcToAKSNodeConfigV1(nbc *datamodel.NodeBootstrappingConfiguration) *aksnodeconfigv1.Configuration {
	...
	bootstrappingConfig := &aksnodeconfigv1.BootstrappingConfig{
		...
		SecureTlsBootstrappingDeadline:                new(nbc.SecureTLSBootstrappingConfig.GetDeadline()),
		SecureTlsBootstrappingAadResource:             new(nbc.SecureTLSBootstrappingConfig.GetAADResource()),
		SecureTlsBootstrappingUserAssignedIdentityId:  new(nbc.SecureTLSBootstrappingConfig.GetUserAssignedIdentityID()),
		SecureTlsBootstrappingCustomClientDownloadUrl: new(nbc.SecureTLSBootstrappingConfig.GetCustomClientDownloadURL()),
	}
	...
	return &aksnodeconfigv1.Configuration{
		...
		LocalDnsProfile: &aksnodeconfigv1.LocalDnsProfile{
			EnableLocalDns:       true,
			CpuLimitInMilliCores: new(int32(2008)),
			MemoryLimitInMb:      new(int32(256)),
			VnetDnsOverrides: map[string]*aksnodeconfigv1.LocalDnsOverrides{
				".": {
					...
					CacheDurationInSeconds:      new(int32(3600)),
					ServeStaleDurationInSeconds: new(int32(3600)),
				...
				"cluster.local": {
					...
					MaxConcurrent:               new(int32(3000)),
					CacheDurationInSeconds:      new(int32(7200)),
					ServeStaleDurationInSeconds: new(int32(4500)),
					ServeStale:                  "Disable",
				},
				"testdomain456.com": {
					QueryLogging:                "Log",
		...
		ContainerService: &datamodel.ContainerService{
			...
			Properties: &datamodel.Properties{
				...
				WindowsProfile: &datamodel.WindowsProfile{
					AlwaysPullWindowsPauseImage:    new(false),
					...
					EnableAutomaticUpdates:         new(false),
