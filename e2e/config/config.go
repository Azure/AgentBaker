...
type Configuration struct {
	...
	DefaultLocation                        string        `env:"E2E_LOCATION" envDefault:"australiaeast"`
	...
	TagsToRun                              string        `env:"TAGS_TO_RUN" envDefault:"GPU=true"`
	...
	TestTimeoutCluster                     time.Duration `env:"TEST_TIMEOUT_CLUSTER" envDefault:"25m"`
