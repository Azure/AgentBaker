...
type Configuration struct {
	...
	BlobContainer                          string        `env:"BLOB_CONTAINER" envDefault:"azltest"`
	BlobStorageAccountPrefix               string        `env:"BLOB_STORAGE_ACCOUNT_PREFIX" envDefault:"azltest"`
	...
	DefaultVMSKU                           string        `env:"DEFAULT_VM_SKU" envDefault:"Standard_D2_v2"`
	...
	TagsToRun                              string        `env:"TAGS_TO_RUN" envDefault:"name=Test_AzureLinuxV3_Supernova_GPU"`
