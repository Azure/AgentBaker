...
func clusterLatestKubernetesVersion(ctx context.Context, request ClusterRequest) (*Cluster, error) {
	...
	return prepareCluster(ctx, model, false, false, false)
}
...
func clusterKubenet(ctx context.Context, request ClusterRequest) (*Cluster, error) {
	return prepareCluster(ctx, getKubenetClusterModel("abe2e-kubenet-v2", request.Location, request.K8sSystemPoolSKU), false, false, false)
}

var ClusterKubenetFirewall = cachedFunc(clusterKubenetFirewall)

// clusterKubenetFirewall creates a basic cluster using kubenet networking with firewall
func clusterKubenetFirewall(ctx context.Context, request ClusterRequest) (*Cluster, error) {
	return prepareCluster(ctx, getKubenetClusterModel("abe2e-kubenet-restricted", request.Location, request.K8sSystemPoolSKU), false, false, true)
}
...
func clusterKubenetAirgap(ctx context.Context, request ClusterRequest) (*Cluster, error) {
	return prepareCluster(ctx, getKubenetClusterModel("abe2e-kubenet-airgap", request.Location, request.K8sSystemPoolSKU), true, false, false)
}
...
func clusterKubenetAirgapNonAnon(ctx context.Context, request ClusterRequest) (*Cluster, error) {
	return prepareCluster(ctx, getKubenetClusterModel("abe2e-kubenet-nonanonpull-airgap", request.Location, request.K8sSystemPoolSKU), true, true, false)
}
...
func clusterAzureNetwork(ctx context.Context, request ClusterRequest) (*Cluster, error) {
	return prepareCluster(ctx, getAzureNetworkClusterModel("abe2e-azure-network", request.Location, request.K8sSystemPoolSKU), false, false, false)
}
...
func clusterAzureOverlayNetwork(ctx context.Context, request ClusterRequest) (*Cluster, error) {
	return prepareCluster(ctx, getAzureOverlayNetworkClusterModel("abe2e-azure-overlay-network", request.Location, request.K8sSystemPoolSKU), false, false, false)
}
...
func clusterAzureOverlayNetworkDualStack(ctx context.Context, request ClusterRequest) (*Cluster, error) {
	return prepareCluster(ctx, getAzureOverlayNetworkDualStackClusterModel("abe2e-azure-overlay-dualstack", request.Location, request.K8sSystemPoolSKU), false, false, false)
}
...
func clusterCiliumNetwork(ctx context.Context, request ClusterRequest) (*Cluster, error) {
	return prepareCluster(ctx, getCiliumNetworkClusterModel("abe2e-cilium-network", request.Location, request.K8sSystemPoolSKU), false, false, false)
}
