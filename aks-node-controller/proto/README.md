...
| `KubernetesPackageVersion` | `string` | Kubernetes package or OCI artifact version. May differ from `KubernetesVersion` for prerelease builds; consumers fall back to `KubernetesVersion` when omitted.                                                                                                          | `KUBERNETES_PACKAGE_VERSION` |
