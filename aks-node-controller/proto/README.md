...
| `IMDSRestrictionConfig` | `IMDSRestrictionConfig` | IMDS restriction configuration
| `IsOSGuard` | `bool` | Specifies if it is an Azure Linux OS Guard node                                                                                                                                                                                                                                           | `IS_OSGUARD` |                                                                                                                                                                                                                                    | `ENABLE_IMDS_RESTRICTION`, `INSERT_IMDS_RESTRICTION_RULE_TO_MANGLE_TABLE`|
