...
type linuxOperatingSystemInfo struct {
}

func (a *linuxOperatingSystemInfo) LogFilePath() string {
...
func (a *linuxOperatingSystemInfo) BuildCSECmd(ctx context.Context, config *aksnodeconfigv1.Configuration) (*exec.Cmd, error) {
