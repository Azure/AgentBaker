...
`)
	...
	t.Run("BootstrappingMethod=UseSecureTLSBootstrapping sets bootstrap-kubeconfig correctly", func(t *testing.T) {
		nbc := validNBC()
		nbc.KubenetesAuthMethod = datamodel.UseSecureTLSBootstrapping
		assertBootstrapKubeconfig(t, nbc, `apiVersion: v1
clusters:
    - cluster:
        certificate-authority: /etc/kubernetes/certs/ca.crt
...
`)
	...
	t.Run("BootstrappingMethod=UseTLSBootstrapToken sets bootstrap-kubeconfig correctly", func(t *testing.T) {
		nbc := validNBC()
		nbc.KubenetesAuthMethod = datamodel.UseTLSBootstrapToken
...
`)
	...
	t.Run("KubenetesAuthMethod=UseArcMsiToMakeCSR sets bootstrap-kubeconfig correctly", func(t *testing.T) {
		nbc := validNBC()
		nbc.KubenetesAuthMethod = datamodel.UseArcMsiToMakeCSR
		assertBootstrapKubeconfig(t, nbc, `apiVersion: v1
clusters:
    - cluster:
        certificate-authority: /etc/kubernetes/certs/ca.crt
...
`)
	...
	t.Run("KubenetesAuthMethod=UseArcMsiToMakeCSR sets token.sh correctly with the AKS AAD App ID", func(t *testing.T) {
		nbc := validNBC()
	...
	t.Run("KubenetesAuthMethod=UseArcMsiToMakeCSR sets token.sh correctly with a different AKS AAD App ID", func(t *testing.T) {
		nbc := validNBC()
	...
	t.Run("KubenetesAuthMethod=UseArcMsiDirectly sets kubeconfig correctly", func(t *testing.T) {
		nbc := validNBC()
		nbc.KubenetesAuthMethod = datamodel.UseArcMsiDirectly
		assertKubeconfig(t, nbc, `
apiVersion: v1
clusters:
- cluster:
...
`)
	...
	t.Run("KubenetesAuthMethod=UseArcMsiDirectly sets token.sh correctly with the AKS AAD App ID", func(t *testing.T) {
		nbc := validNBC()
		nbc.CustomSecureTLSBootstrapAADServerAppID = ""
		nbc.KubenetesAuthMethod = "UseArcMsiDirectly"
		assertArcTokenSh(t, nbc, "6dae42f8-4368-4678-94ff-3960e28e3630")
	})

	t.Run("KubenetesAuthMethod=UseArcMsiDirectly sets token.sh correctly with a different AKS AAD App ID", func(t *testing.T) {
		nbc := validNBC()
		nbc.CustomSecureTLSBootstrapAADServerAppID = "different_app_id"
		nbc.KubenetesAuthMethod = "UseArcMsiDirectly"
		assertArcTokenSh(t, nbc, "different_app_id")
	...
	t.Run("KubenetesAuthMethod=UseAzureMsiDirectly sets kubeconfig correctly", func(t *testing.T) {
		nbc := validNBC()
		nbc.KubenetesAuthMethod = datamodel.UseAzureMsiDirectly
		assertKubeconfig(t, nbc, `
apiVersion: v1
clusters:
   - cluster:
...
`)
	...
	t.Run("KubenetesAuthMethod=UseAzureMsiDirectly sets token.sh correctly with the AKS AAD App ID", func(t *testing.T) {
		nbc := validNBC()
		nbc.CustomSecureTLSBootstrapAADServerAppID = ""
		nbc.KubenetesAuthMethod = datamodel.UseAzureMsiDirectly
	...
	t.Run("KubenetesAuthMethod=UseAzureMsiDirectly sets token.sh correctly with a different AKS AAD App ID", func(t *testing.T) {
		nbc := validNBC()
		nbc.CustomSecureTLSBootstrapAADServerAppID = "different_app_id"
		nbc.KubenetesAuthMethod = datamodel.UseAzureMsiDirectly
	...
	t.Run("KubenetesAuthMethod=UseAzureMsiDirectly and windows sets kubeconfig correctly", func(t *testing.T) {
		nbc := validNBC()
...
`)
	...
	t.Run("KubenetesAuthMethod=UseAzureMsiDirectly and windows has no token-azure or token-arc.sh", func(t *testing.T) {
		nbc := validNBC()
		nbc.AgentPoolProfile.OSType = datamodel.Windows
		nbc.KubenetesAuthMethod = datamodel.UseAzureMsiDirectly
	...
	t.Run("KubenetesAuthMethod=UseAzureMsiDirectly sets kubeconfig correctly", func(t *testing.T) {
		nbc := validNBC()
		nbc.KubenetesAuthMethod = datamodel.UseAzureMsiToMakeCSR
		assertBootstrapKubeconfig(t, nbc, `apiVersion: v1
clusters:
    - cluster:
        certificate-authority: /etc/kubernetes/certs/ca.crt
...
`)
	...
	t.Run("KubenetesAuthMethod=UseAzureMsiToMakeCSR and windows sets bootstrap kubeconfig correctly", func(t *testing.T) {
		nbc := validNBC()
		nbc.AgentPoolProfile.OSType = datamodel.Windows
		nbc.KubenetesAuthMethod = datamodel.UseAzureMsiToMakeCSR
...
`)
	...
	t.Run("KubenetesAuthMethod=UseAzureMsiToMakeCSR and windows has no token-azure or token-arc.sh", func(t *testing.T) {
		nbc := validNBC()
		nbc.AgentPoolProfile.OSType = datamodel.Windows
		nbc.KubenetesAuthMethod = datamodel.UseAzureMsiToMakeCSR
