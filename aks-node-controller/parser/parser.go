...
func getCSEEnv(config *aksnodeconfigv1.Configuration) map[string]string {
	env := map[string]string{
		...
		"SECURE_TLS_BOOTSTRAPPING_DEADLINE":                  getSecureTLSBootstrappingDeadline(config.GetBootstrappingConfig()),
		"SECURE_TLS_BOOTSTRAPPING_AAD_RESOURCE":              getSecureTLSBootstrappingAADResource(config.GetBootstrappingConfig()),
		"SECURE_TLS_BOOTSTRAPPING_USER_ASSIGNED_IDENTITY_ID": getSecureTLSBootstrappingUserAssignedIdentityID(config.GetBootstrappingConfig()),
		"CUSTOM_SECURE_TLS_BOOTSTRAPPING_CLIENT_URL":         getSecureTLSBootstrappingCustomClientDownloadURL(config.GetBootstrappingConfig()),
