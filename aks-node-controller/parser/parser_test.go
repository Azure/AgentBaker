	...
	tests := []struct {
	...
	}{
		{
			...
			aksNodeConfigUpdator: func(aksNodeConfig *aksnodeconfigv1.Configuration) {
				...
				aksNodeConfig.GpuConfig.EnableNvidia = ToPtr(false)
...
`
		...
		},
		{
			...
			k8sVersion: "1.24.2",
			aksNodeConfigUpdator: func(aksNodeConfig *aksnodeconfigv1.Configuration) {
				aksNodeConfig.EnableSsh = ToPtr(true)
			},
			validator: func(cmd *exec.Cmd) {
				vars := environToMap(cmd.Env)
			...
			aksNodeConfigUpdator: func(aksNodeConfig *aksnodeconfigv1.Configuration) {
				aksNodeConfig.CustomLinuxOsConfig = &aksnodeconfigv1.CustomLinuxOsConfig{
					...
					SysctlConfig: &aksnodeconfigv1.SysctlConfig{
						NetCoreSomaxconn:             ToPtr[int32](1638499),
						NetCoreRmemDefault:           ToPtr[int32](456000),
						NetCoreWmemDefault:           ToPtr[int32](89000),
						NetIpv4TcpTwReuse:            ToPtr(true),
						NetIpv4IpLocalPortRange:      ToPtr("32768 65400"),
						NetIpv4TcpMaxSynBacklog:      ToPtr[int32](1638498),
						NetIpv4NeighDefaultGcThresh1: ToPtr[int32](10001),
					},
				}
			},
			validator: func(cmd *exec.Cmd) {
		...
		},
		{
			...
			aksNodeConfigUpdator: func(aksNodeConfig *aksnodeconfigv1.Configuration) {
				...
				aksNodeConfig.NeedsCgroupv2 = ToPtr(true)
			},
			validator: func(cmd *exec.Cmd) {
				vars := environToMap(cmd.Env)
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			aksNodeConfig := &aksnodeconfigv1.Configuration{
				...
				NetworkConfig: &aksnodeconfigv1.NetworkConfig{
					VnetCniPluginsUrl: "https://packages.aks.azure.com/azure-cni/v1.1.3/binaries/azure-vnet-cni-linux-amd64-v1.1.3.tgz",
				},
