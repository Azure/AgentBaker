...
const file_aksnodeconfig_v1_http_proxy_config_proto_rawDesc = "" +
	"\n" +
	"(aksnodeconfig/v1/http_proxy_config.proto\x12\x10aksnodeconfig.v1\"\xa5\x01\n" +
	"\x0fHttpProxyConfig\x12\x1d\n" +
	"\n" +
	"http_proxy\x18\x01 \x01(\tR\thttpProxy\x12\x1f\n" +
	"\vhttps_proxy\x18\x02 \x01(\tR\n" +
	"httpsProxy\x12(\n" +
	"\x10no_proxy_entries\x18\x03 \x03(\tR\x0enoProxyEntries\x12(\n" +
	"\x10proxy_trusted_ca\x18\x04 \x01(\tR\x0eproxyTrustedCaBZZXgithub.com/Azure/agentbaker/aks-node-controller/pkg/gen/aksnodeconfig/v1;aksnodeconfigv1b\x06proto3"

var (
	file_aksnodeconfig_v1_http_proxy_config_proto_rawDescOnce sync.Once
	file_aksnodeconfig_v1_http_proxy_config_proto_rawDescData []byte
)
...
func file_aksnodeconfig_v1_http_proxy_config_proto_rawDescGZIP() []byte {
	file_aksnodeconfig_v1_http_proxy_config_proto_rawDescOnce.Do(func() {
		file_aksnodeconfig_v1_http_proxy_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_aksnodeconfig_v1_http_proxy_config_proto_rawDesc), len(file_aksnodeconfig_v1_http_proxy_config_proto_rawDesc)))
	})
...
func file_aksnodeconfig_v1_http_proxy_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_aksnodeconfig_v1_http_proxy_config_proto_rawDesc), len(file_aksnodeconfig_v1_http_proxy_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
