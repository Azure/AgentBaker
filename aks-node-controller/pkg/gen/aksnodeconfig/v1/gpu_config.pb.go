...
type GpuConfig struct {
	...
	// (i.e., when gpu_instance_profile or mig_profiles is set). Defaults to "Single" if not specified.
	MigStrategy string `protobuf:"bytes,8,opt,name=mig_strategy,json=migStrategy,proto3" json:"mig_strategy,omitempty"`
	// Represents a list of GPU instance profiles to apply for mixed MIG partitioning.
	MigProfiles []string `protobuf:"bytes,9,rep,name=mig_profiles,json=migProfiles,proto3" json:"mig_profiles,omitempty"`
}
...
func (x *GpuConfig) GetMigProfiles() []string {
	if x != nil {
		return x.MigProfiles
	}
	return nil
}
...
var file_aksnodeconfig_v1_gpu_config_proto_rawDesc = []byte{
	...
	0x69, 0x67, 0x2e, 0x76, 0x31, 0x22, 0xd1, 0x03, 0x0a, 0x09, 0x47, 0x70, 0x75, 0x43, 0x6f, 0x6e,
	...
	0x79, 0x12, 0x21, 0x0a, 0x0c, 0x6d, 0x69, 0x67, 0x5f, 0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65,
	0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0b, 0x6d, 0x69, 0x67, 0x50, 0x72, 0x6f, 0x66,
	0x69, 0x6c, 0x65, 0x73, 0x42, 0x10, 0x0a, 0x0e, 0x5f, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x5f,
