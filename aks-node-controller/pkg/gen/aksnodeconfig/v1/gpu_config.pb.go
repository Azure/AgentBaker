...
type GpuConfig struct {
	...
	// Specifies whether the managed GPU experience should run in DRA (Dynamic Resource
	// Allocation) mode instead of the classic device-plugin. Set when the agent pool's
	// gpuProfile has managementMode=Managed and driverMode=DRA. Drives ENABLE_MANAGED_GPU_DRA
	// in the CSE, which switches configureManagedGPUExperience to the dra-driver-nvidia-gpu
	// (+ compute-domain-kubelet-plugin on GB arm64) path.
	EnableManagedGpuDra bool `protobuf:"varint,9,opt,name=enable_managed_gpu_dra,json=enableManagedGpuDra,proto3" json:"enable_managed_gpu_dra,omitempty"`
}
...
var file_aksnodeconfig_v1_gpu_config_proto_rawDesc = []byte{
	...
	0x69, 0x67, 0x2e, 0x76, 0x31, 0x22, 0xe3, 0x03, 0x0a, 0x09, 0x47, 0x70, 0x75, 0x43, 0x6f, 0x6e,
	...
	0x79, 0x12, 0x33, 0x0a, 0x16, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x6d, 0x61, 0x6e, 0x61,
	0x67, 0x65, 0x64, 0x5f, 0x67, 0x70, 0x75, 0x5f, 0x64, 0x72, 0x61, 0x18, 0x09, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x13, 0x65, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x64,
	0x47, 0x70, 0x75, 0x44, 0x72, 0x61, 0x42, 0x10, 0x0a, 0x0e, 0x5f, 0x65, 0x6e, 0x61, 0x62, 0x6c,
	0x65, 0x5f, 0x6e, 0x76, 0x69, 0x64, 0x69, 0x61, 0x42, 0x11, 0x0a, 0x0f, 0x5f, 0x65, 0x6e, 0x61,
	0x62, 0x6c, 0x65, 0x5f, 0x61, 0x6d, 0x64, 0x5f, 0x67, 0x70, 0x75, 0x42, 0x5a, 0x5a, 0x58, 0x67,
