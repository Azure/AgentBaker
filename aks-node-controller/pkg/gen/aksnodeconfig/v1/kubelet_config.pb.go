...
type KubeletConfig struct {
	...
	KubeletFlags map[string]string `protobuf:"bytes,1,rep,name=kubelet_flags,json=kubeletFlags,proto3" json:"kubelet_flags,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// A map of node labels to their values.
	KubeletNodeLabels map[string]string `protobuf:"bytes,2,rep,name=kubelet_node_labels,json=kubeletNodeLabels,proto3" json:"kubelet_node_labels,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type KubeletConfigFileConfig struct {
	...
	// +optional.
	EvictionHard map[string]string `protobuf:"bytes,29,rep,name=eviction_hard,json=evictionHard,proto3" json:"eviction_hard,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	// Default: nil
	// +optional.
	FeatureGates map[string]bool `protobuf:"bytes,31,rep,name=feature_gates,json=featureGates,proto3" json:"feature_gates,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	...
	// Default: nil
	// +optional.
	SystemReserved map[string]string `protobuf:"bytes,35,rep,name=system_reserved,json=systemReserved,proto3" json:"system_reserved,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	// Default: nil
	// +optional.
	KubeReserved map[string]string `protobuf:"bytes,36,rep,name=kube_reserved,json=kubeReserved,proto3" json:"kube_reserved,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
const file_aksnodeconfig_v1_kubelet_config_proto_rawDesc = "" +
	"\n" +
	"%aksnodeconfig/v1/kubelet_config.proto\x12\x10aksnodeconfig.v1\"\xe1\x05\n" +
	"\rKubeletConfig\x12V\n" +
	"\rkubelet_flags\x18\x01 \x03(\v21.aksnodeconfig.v1.KubeletConfig.KubeletFlagsEntryR\fkubeletFlags\x12f\n" +
	"\x13kubelet_node_labels\x18\x02 \x03(\v26.aksnodeconfig.v1.KubeletConfig.KubeletNodeLabelsEntryR\x11kubeletNodeLabels\x12I\n" +
	"\x11kubelet_disk_type\x18\x03 \x01(\x0e2\x1d.aksnodeconfig.v1.KubeletDiskR\x0fkubeletDiskType\x12;\n" +
	"\x1aenable_kubelet_config_file\x18\x04 \x01(\bR\x17enableKubeletConfigFile\x12f\n" +
	"\x1akubelet_config_file_config\x18\x05 \x01(\v2).aksnodeconfig.v1.KubeletConfigFileConfigR\x17kubeletConfigFileConfig\x12,\n" +
	"\x12kubelet_client_key\x18\x06 \x01(\tR\x10kubeletClientKey\x12=\n" +
	"\x1bkubelet_client_cert_content\x18\a \x01(\tR\x18kubeletClientCertContent\x12,\n" +
	"\x12container_data_dir\x18\b \x01(\tR\x10containerDataDir\x1a?\n" +
	"\x11KubeletFlagsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1aD\n" +
	"\x16KubeletNodeLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\"\x89\x15\n" +
	"\x17KubeletConfigFileConfig\x12\x12\n" +
	"\x04kind\x18\x01 \x01(\tR\x04kind\x12\x1f\n" +
	"\vapi_version\x18\x02 \x01(\tR\n" +
	"apiVersion\x12&\n" +
	"\x0fstatic_pod_path\x18\x03 \x01(\tR\rstaticPodPath\x12\x18\n" +
	"\aaddress\x18\x04 \x01(\tR\aaddress\x12$\n" +
	"\x0eread_only_port\x18\x05 \x01(\x05R\freadOnlyPort\x12\"\n" +
	"\rtls_cert_file\x18\x06 \x01(\tR\vtlsCertFile\x12/\n" +
	"\x14tls_private_key_file\x18\a \x01(\tR\x11tlsPrivateKeyFile\x12*\n" +
	"\x11tls_cipher_suites\x18\b \x03(\tR\x0ftlsCipherSuites\x12/\n" +
	"\x13rotate_certificates\x18\t \x01(\bR\x12rotateCertificates\x120\n" +
	"\x14server_tls_bootstrap\x18\n" +
	" \x01(\bR\x12serverTLSBootstrap\x12O\n" +
	"\x0eauthentication\x18\v \x01(\v2'.aksnodeconfig.v1.KubeletAuthenticationR\x0eauthentication\x12L\n" +
	"\rauthorization\x18\f \x01(\v2&.aksnodeconfig.v1.KubeletAuthorizationR\rauthorization\x12-\n" +
	"\x10event_record_qps\x18\r \x01(\x05H\x00R\x0eeventRecordQPS\x88\x01\x01\x12%\n" +
	"\x0ecluster_domain\x18\x0e \x01(\tR\rclusterDomain\x12\x1f\n" +
	"\vcluster_dns\x18\x0f \x03(\tR\n" +
	"clusterDNS\x12I\n" +
	"!streaming_connection_idle_timeout\x18\x10 \x01(\tR\x1estreamingConnectionIdleTimeout\x12?\n" +
	"\x1cnode_status_update_frequency\x18\x11 \x01(\tR\x19nodeStatusUpdateFrequency\x12?\n" +
	"\x1cnode_status_report_frequency\x18\x12 \x01(\tR\x19nodeStatusReportFrequency\x12I\n" +
	"\x1fimage_gc_high_threshold_percent\x18\x13 \x01(\x05H\x01R\x1bimageGCHighThresholdPercent\x88\x01\x01\x12G\n" +
	"\x1eimage_gc_low_threshold_percent\x18\x14 \x01(\x05H\x02R\x1aimageGCLowThresholdPercent\x88\x01\x01\x12+\n" +
	"\x0fcgroups_per_qos\x18\x15 \x01(\bH\x03R\rcgroupsPerQOS\x88\x01\x01\x12,\n" +
	"\x12cpu_manager_policy\x18\x16 \x01(\tR\x10cpuManagerPolicy\x126\n" +
	"\x17topology_manager_policy\x18\x17 \x01(\tR\x15topologyManagerPolicy\x12\x1e\n" +
	"\bmax_pods\x18\x18 \x01(\x05H\x04R\amaxPods\x88\x01\x01\x12)\n" +
	"\x0epod_pids_limit\x18\x19 \x01(\x05H\x05R\fpodPidsLimit\x88\x01\x01\x12\x1f\n" +
	"\vresolv_conf\x18\x1a \x01(\tR\n" +
	"resolvConf\x12'\n" +
	"\rcpu_cfs_quota\x18\x1b \x01(\bH\x06R\vcpuCFSQuota\x88\x01\x01\x12/\n" +
	"\x14cpu_cfs_quota_period\x18\x1c \x01(\tR\x11cpuCFSQuotaPeriod\x12`\n" +
	"\reviction_hard\x18\x1d \x03(\v2;.aksnodeconfig.v1.KubeletConfigFileConfig.EvictionHardEntryR\fevictionHard\x126\n" +
	"\x17protect_kernel_defaults\x18\x1e \x01(\bR\x15protectKernelDefaults\x12`\n" +
	"\rfeature_gates\x18\x1f \x03(\v2;.aksnodeconfig.v1.KubeletConfigFileConfig.FeatureGatesEntryR\ffeatureGates\x12%\n" +
	"\ffail_swap_on\x18  \x01(\bH\aR\n" +
	"failSwapOn\x88\x01\x01\x123\n" +
	"\x16container_log_max_size\x18! \x01(\tR\x13containerLogMaxSize\x12:\n" +
	"\x17container_log_max_files\x18\" \x01(\x05H\bR\x14containerLogMaxFiles\x88\x01\x01\x12f\n" +
	"\x0fsystem_reserved\x18# \x03(\v2=.aksnodeconfig.v1.KubeletConfigFileConfig.SystemReservedEntryR\x0esystemReserved\x12`\n" +
	"\rkube_reserved\x18$ \x03(\v2;.aksnodeconfig.v1.KubeletConfigFileConfig.KubeReservedEntryR\fkubeReserved\x128\n" +
	"\x18enforce_node_allocatable\x18% \x03(\tR\x16enforceNodeAllocatable\x124\n" +
	"\x16allowed_unsafe_sysctls\x18& \x03(\tR\x14allowedUnsafeSysctls\x127\n" +
	"\x15serialize_image_pulls\x18' \x01(\bH\tR\x13serializeImagePulls\x88\x01\x01\x12'\n" +
	"\x0fseccomp_default\x18( \x01(\bR\x0eseccompDefault\x1a?\n" +
	...
	"\x11_event_record_qpsB\"\n" +
	" _image_gc_high_threshold_percentB!\n" +
	"\x1f_image_gc_low_threshold_percentB\x12\n" +
	"\x10_cgroups_per_qosB\v\n" +
	"\t_max_podsB\x11\n" +
	"\x0f_pod_pids_limitB\x10\n" +
	"\x0e_cpu_cfs_quotaB\x0f\n" +
	"\r_fail_swap_onB\x1a\n" +
	"\x18_container_log_max_filesB\x18\n" +
	"\x16_serialize_image_pulls\"\xf2\x01\n" +
	"\x15KubeletAuthentication\x12?\n" +
	"\x04x509\x18\x01 \x01(\v2+.aksnodeconfig.v1.KubeletX509AuthenticationR\x04x509\x12H\n" +
	"\awebhook\x18\x02 \x01(\v2..aksnodeconfig.v1.KubeletWebhookAuthenticationR\awebhook\x12N\n" +
	"\tanonymous\x18\x03 \x01(\v20.aksnodeconfig.v1.KubeletAnonymousAuthenticationR\tanonymous\"A\n" +
	"\x19KubeletX509Authentication\x12$\n" +
	"\x0eclient_ca_file\x18\x01 \x01(\tR\fclientCAFile\"U\n" +
	"\x1cKubeletWebhookAuthentication\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12\x1b\n" +
	"\tcache_ttl\x18\x02 \x01(\tR\bcacheTtl\":\n" +
	"\x1eKubeletAnonymousAuthentication\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\"s\n" +
	"\x14KubeletAuthorization\x12\x12\n" +
	"\x04mode\x18\x01 \x01(\tR\x04mode\x12G\n" +
	"\awebhook\x18\x02 \x01(\v2-.aksnodeconfig.v1.KubeletWebhookAuthorizationR\awebhook\"\x85\x01\n" +
	"\x1bKubeletWebhookAuthorization\x120\n" +
	"\x14cache_authorized_ttl\x18\x01 \x01(\tR\x12cacheAuthorizedTtl\x124\n" +
	"\x16cache_unauthorized_ttl\x18\x02 \x01(\tR\x14cacheUnauthorizedTtl*a\n" +
	"\vKubeletDisk\x12\x1c\n" +
	"\x18KUBELET_DISK_UNSPECIFIED\x10\x00\x12\x18\n" +
	"\x14KUBELET_DISK_OS_DISK\x10\x01\x12\x1a\n" +
	"\x16KUBELET_DISK_TEMP_DISK\x10\x02BZZXgithub.com/Azure/agentbaker/aks-node-controller/pkg/gen/aksnodeconfig/v1;aksnodeconfigv1b\x06proto3"

var (
	file_aksnodeconfig_v1_kubelet_config_proto_rawDescOnce sync.Once
	file_aksnodeconfig_v1_kubelet_config_proto_rawDescData []byte
)
...
func file_aksnodeconfig_v1_kubelet_config_proto_rawDescGZIP() []byte {
	file_aksnodeconfig_v1_kubelet_config_proto_rawDescOnce.Do(func() {
		file_aksnodeconfig_v1_kubelet_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_aksnodeconfig_v1_kubelet_config_proto_rawDesc), len(file_aksnodeconfig_v1_kubelet_config_proto_rawDesc)))
	})
...
func file_aksnodeconfig_v1_kubelet_config_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_aksnodeconfig_v1_kubelet_config_proto_rawDesc), len(file_aksnodeconfig_v1_kubelet_config_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   0,
