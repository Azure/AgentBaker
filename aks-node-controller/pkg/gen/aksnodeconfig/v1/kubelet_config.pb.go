...
type KubeletConfigFileConfig struct {
	...
	// Deprecated since k8s 1.25, removed from KubeletConfiguration in k8s 1.34.
	// This field is cleared by aks-node-controller for k8s >= 1.34 and will not
	// appear in the marshaled config file. Retained in proto for backward
	// compatibility with k8s < 1.34.
	// Default: "4h"
	// +optional.
	// Deprecated: Marked as deprecated in aksnodeconfig/v1/kubelet_config.proto.
	...
	// +optional.
	EvictionSoft map[string]string `protobuf:"bytes,41,rep,name=eviction_soft,json=evictionSoft,proto3" json:"eviction_soft,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	...
	// +optional.
	EvictionSoftGracePeriod map[string]string `protobuf:"bytes,42,rep,name=eviction_soft_grace_period,json=evictionSoftGracePeriod,proto3" json:"eviction_soft_grace_period,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	...
	// Used by AKS Node Memory Hardening (F2/F5).
	// +optional.
	SystemReservedCgroup string `protobuf:"bytes,45,opt,name=system_reserved_cgroup,json=systemReservedCgroup,proto3" json:"system_reserved_cgroup,omitempty"`
	...
	EnableServer             *bool           `protobuf:"varint,46,opt,name=enable_server,json=enableServer,proto3,oneof" json:"enable_server,omitempty"`
	VolumePluginDir          string          `protobuf:"bytes,47,opt,name=volume_plugin_dir,json=volumePluginDir,proto3" json:"volume_plugin_dir,omitempty"`
	CgroupDriver             string          `protobuf:"bytes,48,opt,name=cgroup_driver,json=cgroupDriver,proto3" json:"cgroup_driver,omitempty"`
	RuntimeRequestTimeout    string          `protobuf:"bytes,49,opt,name=runtime_request_timeout,json=runtimeRequestTimeout,proto3" json:"runtime_request_timeout,omitempty"`
	ContainerRuntimeEndpoint string          `protobuf:"bytes,50,opt,name=container_runtime_endpoint,json=containerRuntimeEndpoint,proto3" json:"container_runtime_endpoint,omitempty"`
	RegisterWithTaints       []*KubeletTaint `protobuf:"bytes,51,rep,name=register_with_taints,json=registerWithTaints,proto3" json:"register_with_taints,omitempty"`
	HairpinMode              string          `protobuf:"bytes,52,opt,name=hairpin_mode,json=hairpinMode,proto3" json:"hairpin_mode,omitempty"`
}
...
func (x *KubeletConfigFileConfig) GetEvictionSoft() map[string]string {
	if x != nil {
...
func (x *KubeletConfigFileConfig) GetEvictionSoftGracePeriod() map[string]string {
	if x != nil {
...
func (x *KubeletConfigFileConfig) GetEvictionMaxPodGracePeriod() int32 {
	if x != nil {
...
func (x *KubeletConfigFileConfig) GetKubeReservedCgroup() string {
	if x != nil {
		return x.KubeReservedCgroup
	}
	return ""
}

func (x *KubeletConfigFileConfig) GetSystemReservedCgroup() string {
	if x != nil {
		return x.SystemReservedCgroup
	}
	return ""
}
...
func (x *KubeletConfigFileConfig) GetEnableServer() bool {
...
func (x *KubeletConfigFileConfig) GetVolumePluginDir() string {
	if x != nil {
		return x.VolumePluginDir
	}
	return ""
}

func (x *KubeletConfigFileConfig) GetCgroupDriver() string {
	if x != nil {
...
func (x *KubeletConfigFileConfig) GetRuntimeRequestTimeout() string {
	if x != nil {
		return x.RuntimeRequestTimeout
	}
	return ""
}

func (x *KubeletConfigFileConfig) GetContainerRuntimeEndpoint() string {
	if x != nil {
		return x.ContainerRuntimeEndpoint
	}
	return ""
}

func (x *KubeletConfigFileConfig) GetRegisterWithTaints() []*KubeletTaint {
	if x != nil {
...
func (x *KubeletConfigFileConfig) GetHairpinMode() string {
	if x != nil {
...
func (x *KubeletTaint) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KubeletTaint) ProtoMessage() {}

func (x *KubeletTaint) ProtoReflect() protoreflect.Message {
	mi := &file_aksnodeconfig_v1_kubelet_config_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KubeletTaint.ProtoReflect.Descriptor instead.
func (*KubeletTaint) Descriptor() ([]byte, []int) {
	return file_aksnodeconfig_v1_kubelet_config_proto_rawDescGZIP(), []int{2}
}

func (x *KubeletTaint) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *KubeletTaint) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
func (x *KubeletTaint) GetEffect() string {
	if x != nil {
		return x.Effect
	}
	return ""
...
func (x *KubeletTaint) GetTimeAdded() string {
	if x != nil {
		return x.TimeAdded
	}
	return ""
...
func (x *KubeletWebhookAuthorization) Reset() {
	*x = KubeletWebhookAuthorization{}
	mi := &file_aksnodeconfig_v1_kubelet_config_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KubeletWebhookAuthorization) Descriptor() ([]byte, []int) {
	return file_aksnodeconfig_v1_kubelet_config_proto_rawDescGZIP(), []int{8}
}
...
var file_aksnodeconfig_v1_kubelet_config_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xa4, 0x1c,
	...
	,
	...
	,
	...
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x52, 0x65, 0x73,
	0x65, 0x72, 0x76, 0x65, 0x64, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0e, 0x73, 0x79, 0x73, 0x74,
	0x65, 0x6d, 0x52, 0x65, 0x73, 0x65, 0x72, 0x76, 0x65, 0x64, 0x12, 0x60, 0x0a, 0x0d, 0x6b, 0x75,
	0x62, 0x65, 0x5f, 0x72, 0x65, 0x73, 0x65, 0x72, 0x76, 0x65, 0x64, 0x18, 0x24, 0x20, 0x03, 0x28,
	...
	,
	...
	,
	...
	,
...
var file_aksnodeconfig_v1_kubelet_config_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_aksnodeconfig_v1_kubelet_config_proto_goTypes = []any{
	...
	(*KubeletTaint)(nil),                   // 3: aksnodeconfig.v1.KubeletTaint
	(*KubeletAuthentication)(nil),          // 4: aksnodeconfig.v1.KubeletAuthentication
	(*KubeletX509Authentication)(nil),      // 5: aksnodeconfig.v1.KubeletX509Authentication
	(*KubeletWebhookAuthentication)(nil),   // 6: aksnodeconfig.v1.KubeletWebhookAuthentication
	(*KubeletAnonymousAuthentication)(nil), // 7: aksnodeconfig.v1.KubeletAnonymousAuthentication
	(*KubeletAuthorization)(nil),           // 8: aksnodeconfig.v1.KubeletAuthorization
	(*KubeletWebhookAuthorization)(nil),    // 9: aksnodeconfig.v1.KubeletWebhookAuthorization
	nil,                                    // 10: aksnodeconfig.v1.KubeletConfig.KubeletFlagsEntry
	nil,                                    // 11: aksnodeconfig.v1.KubeletConfig.KubeletNodeLabelsEntry
	nil,                                    // 12: aksnodeconfig.v1.KubeletConfigFileConfig.EvictionHardEntry
	nil,                                    // 13: aksnodeconfig.v1.KubeletConfigFileConfig.FeatureGatesEntry
	nil,                                    // 14: aksnodeconfig.v1.KubeletConfigFileConfig.SystemReservedEntry
	nil,                                    // 15: aksnodeconfig.v1.KubeletConfigFileConfig.KubeReservedEntry
	nil,                                    // 16: aksnodeconfig.v1.KubeletConfigFileConfig.EvictionSoftEntry
	nil,                                    // 17: aksnodeconfig.v1.KubeletConfigFileConfig.EvictionSoftGracePeriodEntry
}
var file_aksnodeconfig_v1_kubelet_config_proto_depIdxs = []int32{
	10, // 0: aksnodeconfig.v1.KubeletConfig.kubelet_flags:type_name -> aksnodeconfig.v1.KubeletConfig.KubeletFlagsEntry
	11, // 1: aksnodeconfig.v1.KubeletConfig.kubelet_node_labels:type_name -> aksnodeconfig.v1.KubeletConfig.KubeletNodeLabelsEntry
	...
	4,  // 4: aksnodeconfig.v1.KubeletConfigFileConfig.authentication:type_name -> aksnodeconfig.v1.KubeletAuthentication
	8,  // 5: aksnodeconfig.v1.KubeletConfigFileConfig.authorization:type_name -> aksnodeconfig.v1.KubeletAuthorization
	12, // 6: aksnodeconfig.v1.KubeletConfigFileConfig.eviction_hard:type_name -> aksnodeconfig.v1.KubeletConfigFileConfig.EvictionHardEntry
	13, // 7: aksnodeconfig.v1.KubeletConfigFileConfig.feature_gates:type_name -> aksnodeconfig.v1.KubeletConfigFileConfig.FeatureGatesEntry
	14, // 8: aksnodeconfig.v1.KubeletConfigFileConfig.system_reserved:type_name -> aksnodeconfig.v1.KubeletConfigFileConfig.SystemReservedEntry
	15, // 9: aksnodeconfig.v1.KubeletConfigFileConfig.kube_reserved:type_name -> aksnodeconfig.v1.KubeletConfigFileConfig.KubeReservedEntry
	16, // 10: aksnodeconfig.v1.KubeletConfigFileConfig.eviction_soft:type_name -> aksnodeconfig.v1.KubeletConfigFileConfig.EvictionSoftEntry
	17, // 11: aksnodeconfig.v1.KubeletConfigFileConfig.eviction_soft_grace_period:type_name -> aksnodeconfig.v1.KubeletConfigFileConfig.EvictionSoftGracePeriodEntry
	3,  // 12: aksnodeconfig.v1.KubeletConfigFileConfig.register_with_taints:type_name -> aksnodeconfig.v1.KubeletTaint
	5,  // 13: aksnodeconfig.v1.KubeletAuthentication.x509:type_name -> aksnodeconfig.v1.KubeletX509Authentication
	6,  // 14: aksnodeconfig.v1.KubeletAuthentication.webhook:type_name -> aksnodeconfig.v1.KubeletWebhookAuthentication
	7,  // 15: aksnodeconfig.v1.KubeletAuthentication.anonymous:type_name -> aksnodeconfig.v1.KubeletAnonymousAuthentication
	9,  // 16: aksnodeconfig.v1.KubeletAuthorization.webhook:type_name -> aksnodeconfig.v1.KubeletWebhookAuthorization
