...
type LocalDnsProfile struct {
	...
	EnableHostsPlugin bool `protobuf:"varint,6,opt,name=enable_hosts_plugin,json=enableHostsPlugin,proto3" json:"enable_hosts_plugin,omitempty"`
	// List of critical FQDNs to resolve for the hosts plugin.
	// Passed from RP so the script doesn't need cloud-specific logic.
	CriticalFqdns []string `protobuf:"bytes,7,rep,name=critical_fqdns,json=criticalFqdns,proto3" json:"critical_fqdns,omitempty"`
	// Optional refresh interval in seconds for the hosts plugin timer.
	// When set to a positive value, provisioning rewrites aks-localdns-hosts-setup.timer
	// before enabling it.
	HostsPluginRefreshIntervalInSeconds *int32 `protobuf:"varint,8,opt,name=hosts_plugin_refresh_interval_in_seconds,json=hostsPluginRefreshIntervalInSeconds,proto3,oneof" json:"hosts_plugin_refresh_interval_in_seconds,omitempty"`
}
...
func (x *LocalDnsProfile) GetEnableHostsPlugin() bool {
	if x != nil {
		return x.EnableHostsPlugin
	}
	return false
}

func (x *LocalDnsProfile) GetCriticalFqdns() []string {
	if x != nil {
		return x.CriticalFqdns
	}
	return nil
}

func (x *LocalDnsProfile) GetHostsPluginRefreshIntervalInSeconds() int32 {
	if x != nil && x.HostsPluginRefreshIntervalInSeconds != nil {
		return *x.HostsPluginRefreshIntervalInSeconds
	}
	return 0
}
...
type LocalDnsOverrides struct {
	...
	FailfastAllUnhealthyUpstreams *bool `protobuf:"varint,9,opt,name=failfast_all_unhealthy_upstreams,json=failfastAllUnhealthyUpstreams,proto3,oneof" json:"failfast_all_unhealthy_upstreams,omitempty"`
	// Configures CoreDNS forward plugin health checking behavior for upstream servers.
	HealthCheck *LocalDnsHealthCheck `protobuf:"bytes,10,opt,name=health_check,json=healthCheck,proto3" json:"health_check,omitempty"`
...
func (x *LocalDnsOverrides) GetFailfastAllUnhealthyUpstreams() bool {
	if x != nil && x.FailfastAllUnhealthyUpstreams != nil {
		return *x.FailfastAllUnhealthyUpstreams
	}
	return false
}

func (x *LocalDnsOverrides) GetHealthCheck() *LocalDnsHealthCheck {
	if x != nil {
...
func (x *LocalDnsOverrides) GetServeStalePolicy() string {
	if x != nil {
		return x.ServeStalePolicy
	}
	return ""
}
...
type LocalDnsHealthCheck struct {
	...
	NoRec *bool `protobuf:"varint,2,opt,name=no_rec,json=noRec,proto3,oneof" json:"no_rec,omitempty"`
...
func (x *LocalDnsHealthCheck) Reset() {
	*x = LocalDnsHealthCheck{}
	mi := &file_aksnodeconfig_v1_localdns_config_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *LocalDnsHealthCheck) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LocalDnsHealthCheck) ProtoMessage() {}

func (x *LocalDnsHealthCheck) ProtoReflect() protoreflect.Message {
	mi := &file_aksnodeconfig_v1_localdns_config_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LocalDnsHealthCheck.ProtoReflect.Descriptor instead.
func (*LocalDnsHealthCheck) Descriptor() ([]byte, []int) {
	return file_aksnodeconfig_v1_localdns_config_proto_rawDescGZIP(), []int{2}
}

func (x *LocalDnsHealthCheck) GetDuration() string {
...
func (x *LocalDnsHealthCheck) GetNoRec() bool {
	if x != nil && x.NoRec != nil {
		return *x.NoRec
	}
	return false
}

func (x *LocalDnsHealthCheck) GetDomain() string {
...
var file_aksnodeconfig_v1_localdns_config_proto_rawDesc = []byte{
	...
	0x65, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x76, 0x31, 0x22, 0xe0, 0x06, 0x0a, 0x0f, 0x4c,
	...
	,
	...
	0x69, 0x67, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x44, 0x6e, 0x73, 0x4f, 0x76,
	0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x73, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02,
	0x38, 0x01, 0x1a, 0x68, 0x0a, 0x15, 0x4b, 0x75, 0x62, 0x65, 0x44, 0x6e, 0x73, 0x4f, 0x76, 0x65,
	...
	,
	...
	,
...
var file_aksnodeconfig_v1_localdns_config_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_aksnodeconfig_v1_localdns_config_proto_goTypes = []any{
	...
	(*LocalDnsHealthCheck)(nil), // 2: aksnodeconfig.v1.LocalDnsHealthCheck
...
var file_aksnodeconfig_v1_localdns_config_proto_depIdxs = []int32{
	...
	2, // 2: aksnodeconfig.v1.LocalDnsOverrides.health_check:type_name -> aksnodeconfig.v1.LocalDnsHealthCheck
	1, // 3: aksnodeconfig.v1.LocalDnsProfile.VnetDnsOverridesEntry.value:type_name -> aksnodeconfig.v1.LocalDnsOverrides
	1, // 4: aksnodeconfig.v1.LocalDnsProfile.KubeDnsOverridesEntry.value:type_name -> aksnodeconfig.v1.LocalDnsOverrides
