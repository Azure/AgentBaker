...
type Configuration struct {
	...
	// cluster/user config
	KubernetesVersion string `protobuf:"bytes,2,opt,name=kubernetes_version,json=kubernetesVersion,proto3" json:"kubernetes_version,omitempty"` // Q: can this be auto-detected? Or is this part of specifying the desired node version?
	// removed kubernetesHyperkubeSpec
	KubeBinaryUrl          string                 `protobuf:"bytes,3,opt,name=kube_binary_url,json=kubeBinaryUrl,proto3" json:"kube_binary_url,omitempty"` // maybe we can combine this and custom_kube_binary_url later once we figure out the logic of how they are used.
	CustomKubeBinaryUrl    string                 `protobuf:"bytes,4,opt,name=custom_kube_binary_url,json=customKubeBinaryUrl,proto3" json:"custom_kube_binary_url,omitempty"`
	KubeproxyUrl           string                 `protobuf:"bytes,5,opt,name=kubeproxy_url,json=kubeproxyUrl,proto3" json:"kubeproxy_url,omitempty"`
	ApiserverConfig        *ApiServerConfig       `protobuf:"bytes,6,opt,name=apiserver_config,json=apiserverConfig,proto3" json:"apiserver_config,omitempty"`
	...
	VmType                 string                 `protobuf:"bytes,10,opt,name=vm_type,json=vmType,proto3" json:"vm_type,omitempty"`
	PrimaryAvailabilitySet string                 `protobuf:"bytes,11,opt,name=primary_availability_set,json=primaryAvailabilitySet,proto3" json:"primary_availability_set,omitempty"`
	PrimaryScaleSet        string                 `protobuf:"bytes,12,opt,name=primary_scale_set,json=primaryScaleSet,proto3" json:"primary_scale_set,omitempty"`
	CloudProviderConfig    *CloudProviderConfig   `protobuf:"bytes,13,opt,name=cloud_provider_config,json=cloudProviderConfig,proto3" json:"cloud_provider_config,omitempty"`
	IdentityConfiguration  *IdentityConfiguration `protobuf:"bytes,14,opt,name=identity_configuration,json=identityConfiguration,proto3" json:"identity_configuration,omitempty"`
	RuncConfig             *RuncConfig            `protobuf:"bytes,15,opt,name=runc_config,json=runcConfig,proto3" json:"runc_config,omitempty"`
	// ... and a bunch of user-specified config
	RepoDepotEndpoint  string `protobuf:"bytes,16,opt,name=repo_depot_endpoint,json=repoDepotEndpoint,proto3" json:"repo_depot_endpoint,omitempty"`
	LinuxAdminUsername string `protobuf:"bytes,17,opt,name=linux_admin_username,json=linuxAdminUsername,proto3" json:"linux_admin_username,omitempty"`
	// removed mobyVersion
	TenantId            string              `protobuf:"bytes,18,opt,name=tenant_id,json=tenantId,proto3" json:"tenant_id,omitempty"`
	UseInstanceMetadata bool                `protobuf:"varint,19,opt,name=use_instance_metadata,json=useInstanceMetadata,proto3" json:"use_instance_metadata,omitempty"`
	LoadBalancerConfig  *LoadBalancerConfig `protobuf:"bytes,20,opt,name=load_balancer_config,json=loadBalancerConfig,proto3" json:"load_balancer_config,omitempty"`
	// removed containerRuntime
	// removed cliTool because docker is deprecated. Only "ctr" will be supported.
	ContainerdConfig          *ContainerdConfig     `protobuf:"bytes,21,opt,name=containerd_config,json=containerdConfig,proto3" json:"containerd_config,omitempty"`
	IsVhd                     bool                  `protobuf:"varint,22,opt,name=is_vhd,json=isVhd,proto3" json:"is_vhd,omitempty"`
	GpuConfig                 *GpuConfig            `protobuf:"bytes,23,opt,name=gpu_config,json=gpuConfig,proto3" json:"gpu_config,omitempty"`
	IsSgxNode                 bool                  `protobuf:"varint,24,opt,name=is_sgx_node,json=isSgxNode,proto3" json:"is_sgx_node,omitempty"`
	TeleportConfig            *TeleportConfig       `protobuf:"bytes,25,opt,name=teleport_config,json=teleportConfig,proto3" json:"teleport_config,omitempty"` // removed NEEDS_CONTAINERD because it's always needed now
	HttpProxyConfiguration    *HttpProxyConfig      `protobuf:"bytes,26,opt,name=http_proxy_configuration,json=httpProxyConfiguration,proto3" json:"http_proxy_configuration,omitempty"`
	SshStatus                 FeatureState          `protobuf:"varint,27,opt,name=ssh_status,json=sshStatus,proto3,enum=agentbaker.v1.FeatureState" json:"ssh_status,omitempty"`
	UnattendedUpgradeStatus   FeatureState          `protobuf:"varint,28,opt,name=unattended_upgrade_status,json=unattendedUpgradeStatus,proto3,enum=agentbaker.v1.FeatureState" json:"unattended_upgrade_status,omitempty"`
	...
	Sysctls                   *SysctlConfig         `protobuf:"bytes,30,opt,name=sysctls,proto3" json:"sysctls,omitempty"`
	...
	GpuInstanceProfile        *string               `protobuf:"bytes,32,opt,name=gpu_instance_profile,json=gpuInstanceProfile,proto3,oneof" json:"gpu_instance_profile,omitempty"`
	HostsConfigAgentStatus    FeatureState          `protobuf:"varint,33,opt,name=hosts_config_agent_status,json=hostsConfigAgentStatus,proto3,enum=agentbaker.v1.FeatureState" json:"hosts_config_agent_status,omitempty"`
	...
	ArtifactStreamingStatus   FeatureState          `protobuf:"varint,35,opt,name=artifact_streaming_status,json=artifactStreamingStatus,proto3,enum=agentbaker.v1.FeatureState" json:"artifact_streaming_status,omitempty"`
	CustomLinuxOsConfig       *CustomLinuxOSConfig  `protobuf:"bytes,36,opt,name=custom_linux_os_config,json=customLinuxOsConfig,proto3" json:"custom_linux_os_config,omitempty"`
	CustomSearchDomain        *CustomSearchDomain   `protobuf:"bytes,37,opt,name=custom_search_domain,json=customSearchDomain,proto3" json:"custom_search_domain,omitempty"`
	TlsBootstrapping          *TLSBootstrapping     `protobuf:"bytes,38,opt,name=tls_bootstrapping,json=tlsBootstrapping,proto3" json:"tls_bootstrapping,omitempty"`
	Ipv6DualStackEnabled      FeatureState          `protobuf:"varint,39,opt,name=ipv6_dual_stack_enabled,json=ipv6DualStackEnabled,proto3,enum=agentbaker.v1.FeatureState" json:"ipv6_dual_stack_enabled,omitempty"`
	PrivateEgressProxyAddress string                `protobuf:"bytes,40,opt,name=private_egress_proxy_address,json=privateEgressProxyAddress,proto3" json:"private_egress_proxy_address,omitempty"`
	ServicePrincipal          *ServicePrincipal     `protobuf:"bytes,41,opt,name=service_principal,json=servicePrincipal,proto3" json:"service_principal,omitempty"`
}
...
func (x *Configuration) GetArtifactStreamingStatus() FeatureState {
	if x != nil {
		return x.ArtifactStreamingStatus
	}
	return FeatureState_FEATURE_STATE_UNSPECIFIED
}
...
func (x *Configuration) GetTlsBootstrapping() *TLSBootstrapping {
	if x != nil {
...
func (x *Configuration) GetServicePrincipal() *ServicePrincipal {
	if x != nil {
...
type KubeletConfiguration struct {
	...
	KubeletConfigFileContent string            `protobuf:"bytes,6,opt,name=kubelet_config_file_content,json=kubeletConfigFileContent,proto3" json:"kubelet_config_file_content,omitempty"` // analyze this further but looks like this will be needed
}
...
type GpuConfig struct {
	...
	GpuDriverVersion              string       `protobuf:"bytes,6,opt,name=gpu_driver_version,json=gpuDriverVersion,proto3" json:"gpu_driver_version,omitempty"`                                                                               // this depends only on VM size as stated above, can probably be placed on the VHD, sync with Ganesh on this
	GpuInstanceProfile            string       `protobuf:"bytes,7,opt,name=gpu_instance_profile,json=gpuInstanceProfile,proto3" json:"gpu_instance_profile,omitempty"`                                                                         // this is tied to MIG, clean this up once there is clarity
}
...
func (x *CustomLinuxOSConfig) Reset() {
	*x = CustomLinuxOSConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_agentbaker_v1_config_proto_msgTypes[19]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomLinuxOSConfig) Descriptor() ([]byte, []int) {
	return file_agentbaker_v1_config_proto_rawDescGZIP(), []int{19}
}
...
func (x *CustomSearchDomain) Reset() {
	*x = CustomSearchDomain{}
	if protoimpl.UnsafeEnabled {
		mi := &file_agentbaker_v1_config_proto_msgTypes[20]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomSearchDomain) Descriptor() ([]byte, []int) {
	return file_agentbaker_v1_config_proto_rawDescGZIP(), []int{20}
}
...
type TLSBootstrapping struct {
	...
	TlsBootstrapping       FeatureState `protobuf:"varint,1,opt,name=tls_bootstrapping,json=tlsBootstrapping,proto3,enum=agentbaker.v1.FeatureState" json:"tls_bootstrapping,omitempty"`
	SecureTlsBootstrapping FeatureState `protobuf:"varint,2,opt,name=secure_tls_bootstrapping,json=secureTlsBootstrapping,proto3,enum=agentbaker.v1.FeatureState" json:"secure_tls_bootstrapping,omitempty"`
...
func (x *TLSBootstrapping) Reset() {
	*x = TLSBootstrapping{}
	if protoimpl.UnsafeEnabled {
		mi := &file_agentbaker_v1_config_proto_msgTypes[21]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TLSBootstrapping) Descriptor() ([]byte, []int) {
	return file_agentbaker_v1_config_proto_rawDescGZIP(), []int{21}
}
...
func (x *CustomCloudConfig) Reset() {
	*x = CustomCloudConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_agentbaker_v1_config_proto_msgTypes[22]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomCloudConfig) Descriptor() ([]byte, []int) {
	return file_agentbaker_v1_config_proto_rawDescGZIP(), []int{22}
}
...
type ServicePrincipal struct {
	...
	ServicePrincipalFileContent string `protobuf:"bytes,1,opt,name=service_principal_file_content,json=servicePrincipalFileContent,proto3" json:"service_principal_file_content,omitempty"`
	KubeletClientKey            string `protobuf:"bytes,2,opt,name=kubelet_client_key,json=kubeletClientKey,proto3" json:"kubelet_client_key,omitempty"`
	KubeletClientCert           string `protobuf:"bytes,3,opt,name=kubelet_client_cert,json=kubeletClientCert,proto3" json:"kubelet_client_cert,omitempty"`
}

func (x *ServicePrincipal) Reset() {
	*x = ServicePrincipal{}
	if protoimpl.UnsafeEnabled {
		mi := &file_agentbaker_v1_config_proto_msgTypes[23]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ServicePrincipal) Descriptor() ([]byte, []int) {
	return file_agentbaker_v1_config_proto_rawDescGZIP(), []int{23}
}

func (x *ServicePrincipal) GetServicePrincipalFileContent() string {
	if x != nil {
		return x.ServicePrincipalFileContent
	}
	return ""
}

func (x *ServicePrincipal) GetKubeletClientKey() string {
	if x != nil {
...
func (x *ServicePrincipal) GetKubeletClientCert() string {
	if x != nil {
		return x.KubeletClientCert
	}
	return ""
}
...
var file_agentbaker_v1_config_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x74, 0x62, 0x61, 0x6b, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x22, 0x9f, 0x14, 0x0a, 0x0d,
	...
	0x79, 0x12, 0x2d, 0x0a, 0x12, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x5f,
	...
	0x75, 0x72, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x6b, 0x75, 0x62, 0x65, 0x42,
	...
	0x72, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x13, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d,
	0x4b, 0x75, 0x62, 0x65, 0x42, 0x69, 0x6e, 0x61, 0x72, 0x79, 0x55, 0x72, 0x6c, 0x12, 0x23, 0x0a,
	0x0d, 0x6b, 0x75, 0x62, 0x65, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x05,
	...
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x61,
	...
	0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70,
	0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x25, 0x0a, 0x0e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x5f, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d,
	...
	0x74, 0x79, 0x70, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x76, 0x6d, 0x54, 0x79,
	0x70, 0x65, 0x12, 0x38, 0x0a, 0x18, 0x70, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79, 0x5f, 0x61, 0x76,
	0x61, 0x69, 0x6c, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x5f, 0x73, 0x65, 0x74, 0x18, 0x0b,
	...
	0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x70, 0x72, 0x69, 0x6d, 0x61, 0x72, 0x79,
	...
	0x67, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x62,
	...
	0x66, 0x69, 0x67, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0b,
	...
	0x0b, 0x72, 0x75, 0x6e, 0x63, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x0f, 0x20, 0x01,
	...
	0x18, 0x10, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x72, 0x65, 0x70, 0x6f, 0x44, 0x65, 0x70, 0x6f,
	...
	0x65, 0x18, 0x11, 0x20, 0x01, 0x28, 0x09, 0x52, 0x12, 0x6c, 0x69, 0x6e, 0x75, 0x78, 0x41, 0x64,
	0x6d, 0x69, 0x6e, 0x55, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x74,
	0x65, 0x6e, 0x61, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x12, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
	...
	0x61, 0x18, 0x13, 0x20, 0x01, 0x28, 0x08, 0x52, 0x13, 0x75, 0x73, 0x65, 0x49, 0x6e, 0x73, 0x74,
	...
	0x6e, 0x66, 0x69, 0x67, 0x18, 0x14, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x61, 0x67, 0x65,
	...
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x15, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x61,
	...
	0x15, 0x0a, 0x06, 0x69, 0x73, 0x5f, 0x76, 0x68, 0x64, 0x18, 0x16, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x05, 0x69, 0x73, 0x56, 0x68, 0x64, 0x12, 0x37, 0x0a, 0x0a, 0x67, 0x70, 0x75, 0x5f, 0x63, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x18, 0x17, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x61, 0x67, 0x65,
	...
	0x1e, 0x0a, 0x0b, 0x69, 0x73, 0x5f, 0x73, 0x67, 0x78, 0x5f, 0x6e, 0x6f, 0x64, 0x65, 0x18, 0x18,
	...
	0x69, 0x67, 0x18, 0x19, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74,
	...
	0x69, 0x6f, 0x6e, 0x18, 0x1a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x61, 0x67, 0x65, 0x6e,
	...
	0x1b, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x62, 0x61, 0x6b,
	...
	,
	...
	0x5f, 0x74, 0x72, 0x75, 0x73, 0x74, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x22, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x62, 0x61, 0x6b, 0x65, 0x72,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x54, 0x79,
	...
	,
	...
	0x6c, 0x75, 0x65, 0x22, 0x51, 0x0a, 0x14, 0x56, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x4e, 0x65,
	...
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x62, 0x61, 0x6b,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x62, 0x61,
	0x6b, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x50, 0x72, 0x6f, 0x76,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1e, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x62, 0x61,
	0x6b, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x6f, 0x61, 0x64, 0x42, 0x61, 0x6c, 0x61, 0x6e,
	...
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x62,
	0x61, 0x6b, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x53,
	...
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x62, 0x61, 0x6b, 0x65,
	0x72, 0x2e, 0x76, 0x31, 0x2e, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x53, 0x74, 0x61, 0x74,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1b, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x62, 0x61,
	...
	0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x62,
	0x61, 0x6b, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x50,
	...
	0x61, 0x67, 0x65, 0x6e, 0x74, 0x62, 0x61, 0x6b, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x56, 0x69,
	...
	,
	...
	,
	...
	0x61, 0x70, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x8d, 0x01, 0x0a, 0x11, 0x43, 0x75, 0x73, 0x74,
	...
	,
	...
	0x42, 0xad, 0x01, 0x0a, 0x11, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x62, 0x61,
	0x6b, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x42, 0x0b, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x50, 0x72,
	...
	0x65, 0x72, 0x2f, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x62, 0x61, 0x6b, 0x65, 0x72, 0x2f, 0x76, 0x31,
	0x3b, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x62, 0x61, 0x6b, 0x65, 0x72, 0x76, 0x31, 0xa2, 0x02, 0x03,
	0x41, 0x58, 0x58, 0xaa, 0x02, 0x0d, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x62, 0x61, 0x6b, 0x65, 0x72,
	0x2e, 0x56, 0x31, 0xca, 0x02, 0x0d, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x62, 0x61, 0x6b, 0x65, 0x72,
	0x5c, 0x56, 0x31, 0xe2, 0x02, 0x19, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x62, 0x61, 0x6b, 0x65, 0x72,
	0x5c, 0x56, 0x31, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea,
	0x02, 0x0e, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x62, 0x61, 0x6b, 0x65, 0x72, 0x3a, 0x3a, 0x56, 0x31,
...
var file_agentbaker_v1_config_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_agentbaker_v1_config_proto_goTypes = []interface{}{
	...
	(*CustomLinuxOSConfig)(nil),          // 26: agentbaker.v1.CustomLinuxOSConfig
	(*CustomSearchDomain)(nil),           // 27: agentbaker.v1.CustomSearchDomain
	(*TLSBootstrapping)(nil),             // 28: agentbaker.v1.TLSBootstrapping
	(*CustomCloudConfig)(nil),            // 29: agentbaker.v1.CustomCloudConfig
	(*ServicePrincipal)(nil),             // 30: agentbaker.v1.ServicePrincipal
	nil,                                  // 31: agentbaker.v1.KubeletConfiguration.KubeletNodeLabelsEntry
}
var file_agentbaker_v1_config_proto_depIdxs = []int32{
	...
	0,  // 15: agentbaker.v1.Configuration.artifact_streaming_status:type_name -> agentbaker.v1.FeatureState
	26, // 16: agentbaker.v1.Configuration.custom_linux_os_config:type_name -> agentbaker.v1.CustomLinuxOSConfig
	27, // 17: agentbaker.v1.Configuration.custom_search_domain:type_name -> agentbaker.v1.CustomSearchDomain
	28, // 18: agentbaker.v1.Configuration.tls_bootstrapping:type_name -> agentbaker.v1.TLSBootstrapping
	0,  // 19: agentbaker.v1.Configuration.ipv6_dual_stack_enabled:type_name -> agentbaker.v1.FeatureState
	30, // 20: agentbaker.v1.Configuration.service_principal:type_name -> agentbaker.v1.ServicePrincipal
	31, // 21: agentbaker.v1.KubeletConfiguration.kubelet_node_labels:type_name -> agentbaker.v1.KubeletConfiguration.KubeletNodeLabelsEntry
	13, // 22: agentbaker.v1.KubeletConfiguration.taints:type_name -> agentbaker.v1.Taint
	13, // 23: agentbaker.v1.KubeletConfiguration.startup_taints:type_name -> agentbaker.v1.Taint
	4,  // 24: agentbaker.v1.KubeletConfiguration.kubelet_disk_type:type_name -> agentbaker.v1.KubeletDiskType
	14, // 25: agentbaker.v1.SysctlConfig.sysctls:type_name -> agentbaker.v1.Sysctl
	1,  // 26: agentbaker.v1.IdentityConfiguration.identity_type:type_name -> agentbaker.v1.IdentityType
	0,  // 27: agentbaker.v1.HttpProxyConfig.http_proxy_config_status:type_name -> agentbaker.v1.FeatureState
	0,  // 28: agentbaker.v1.HttpProxyConfig.http_proxy_ca_config_status:type_name -> agentbaker.v1.FeatureState
	0,  // 29: agentbaker.v1.CustomCaTrustConfig.custom_ca_trust_status:type_name -> agentbaker.v1.FeatureState
	17, // 30: agentbaker.v1.CloudProviderConfig.cloud_provider_backoff_config:type_name -> agentbaker.v1.CloudProviderBackoffConfig
	18, // 31: agentbaker.v1.CloudProviderConfig.cloud_provider_rate_limit_config:type_name -> agentbaker.v1.CloudProviderRateLimitConfig
	0,  // 32: agentbaker.v1.CloudProviderBackoffConfig.status:type_name -> agentbaker.v1.FeatureState
	0,  // 33: agentbaker.v1.CloudProviderRateLimitConfig.status:type_name -> agentbaker.v1.FeatureState
	5,  // 34: agentbaker.v1.LoadBalancerConfig.load_balancer_sku:type_name -> agentbaker.v1.LoadBalancerSku
	0,  // 35: agentbaker.v1.GpuConfig.status:type_name -> agentbaker.v1.FeatureState
	0,  // 36: agentbaker.v1.GpuConfig.is_mig_node:type_name -> agentbaker.v1.FeatureState
	0,  // 37: agentbaker.v1.GpuConfig.config_gpu_driver_if_needed:type_name -> agentbaker.v1.FeatureState
	0,  // 38: agentbaker.v1.GpuConfig.enable_gpu_device_plugin_if_needed:type_name -> agentbaker.v1.FeatureState
	0,  // 39: agentbaker.v1.GpuConfig.fabric_manager_status:type_name -> agentbaker.v1.FeatureState
	0,  // 40: agentbaker.v1.TeleportConfig.status:type_name -> agentbaker.v1.FeatureState
	2,  // 41: agentbaker.v1.NetworkConfig.network_plugin:type_name -> agentbaker.v1.NetworkPluginType
	3,  // 42: agentbaker.v1.NetworkConfig.network_policy:type_name -> agentbaker.v1.NetworkPolicyType
	6,  // 43: agentbaker.v1.NetworkConfig.network_mode:type_name -> agentbaker.v1.NetworkMode
	15, // 44: agentbaker.v1.NetworkConfig.virtual_network_config:type_name -> agentbaker.v1.VirtualNetworkConfig
	0,  // 45: agentbaker.v1.TLSBootstrapping.tls_bootstrapping:type_name -> agentbaker.v1.FeatureState
	0,  // 46: agentbaker.v1.TLSBootstrapping.secure_tls_bootstrapping:type_name -> agentbaker.v1.FeatureState
...
func file_agentbaker_v1_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_agentbaker_v1_config_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
		...
		file_agentbaker_v1_config_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
		...
		file_agentbaker_v1_config_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
		...
		file_agentbaker_v1_config_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
		...
		file_agentbaker_v1_config_proto_msgTypes[23].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ServicePrincipal); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
