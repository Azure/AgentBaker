...
type NodePoolProfileConfig struct {
...
func (x *NodePoolProfileConfig) Reset() {
	*x = NodePoolProfileConfig{}
...
func (x *NodePoolProfileConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NodePoolProfileConfig) ProtoMessage() {}

func (x *NodePoolProfileConfig) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_proto_nbcontract_v1_nodepoolprofile_proto_msgTypes[0]
...
// Deprecated: Use NodePoolProfileConfig.ProtoReflect.Descriptor instead.
func (*NodePoolProfileConfig) Descriptor() ([]byte, []int) {
	return file_pkg_proto_nbcontract_v1_nodepoolprofile_proto_rawDescGZIP(), []int{0}
}

func (x *NodePoolProfileConfig) GetVmSize() string {
	if x != nil {
		return x.VmSize
	}
	return ""
...
var file_pkg_proto_nbcontract_v1_nodepoolprofile_proto_rawDesc = []byte{
	...
	0x0d, 0x6e, 0x62, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x2e, 0x76, 0x31, 0x22, 0x30,
	0x0a, 0x15, 0x4e, 0x6f, 0x64, 0x65, 0x50, 0x6f, 0x6f, 0x6c, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c,
	0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x17, 0x0a, 0x07, 0x76, 0x6d, 0x5f, 0x73, 0x69,
	0x7a, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x76, 0x6d, 0x53, 0x69, 0x7a, 0x65,
	0x42, 0xc0, 0x01, 0x0a, 0x11, 0x63, 0x6f, 0x6d, 0x2e, 0x6e, 0x62, 0x63, 0x6f, 0x6e, 0x74, 0x72,
	0x61, 0x63, 0x74, 0x2e, 0x76, 0x31, 0x42, 0x14, 0x4e, 0x6f, 0x64, 0x65, 0x70, 0x6f, 0x6f, 0x6c,
	0x70, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x40,
...
var file_pkg_proto_nbcontract_v1_nodepoolprofile_proto_goTypes = []interface{}{
	(*NodePoolProfileConfig)(nil), // 0: nbcontract.v1.NodePoolProfileConfig
}
...
func file_pkg_proto_nbcontract_v1_nodepoolprofile_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_proto_nbcontract_v1_nodepoolprofile_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NodePoolProfileConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
