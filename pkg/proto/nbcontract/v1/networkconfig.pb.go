...
var file_pkg_proto_nbcontract_v1_networkconfig_proto_goTypes = []any{
...
func file_pkg_proto_nbcontract_v1_networkconfig_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_proto_nbcontract_v1_networkconfig_proto_msgTypes[0].Exporter = func(v any, i int) any {
