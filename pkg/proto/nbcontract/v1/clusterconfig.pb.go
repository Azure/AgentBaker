...
var file_pkg_proto_nbcontract_v1_clusterconfig_proto_goTypes = []any{
...
func file_pkg_proto_nbcontract_v1_clusterconfig_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_proto_nbcontract_v1_clusterconfig_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pkg_proto_nbcontract_v1_clusterconfig_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_pkg_proto_nbcontract_v1_clusterconfig_proto_msgTypes[2].Exporter = func(v any, i int) any {
	...
	file_pkg_proto_nbcontract_v1_clusterconfig_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
