...
// Enum value maps for ClusterNetworkConfig_NetworkPlugin.
var (
	ClusterNetworkConfig_NetworkPlugin_name = map[int32]string{
		0: "NP_UNSPECIFIED",
		1: "NP_NONE",
		2: "NP_AZURE",
		3: "NP_KUBENET",
	}
	ClusterNetworkConfig_NetworkPlugin_value = map[string]int32{
		"NP_UNSPECIFIED": 0,
		"NP_NONE":        1,
		"NP_AZURE":       2,
		"NP_KUBENET":     3,
...
func (x ClusterNetworkConfig_NetworkPlugin) Enum() *ClusterNetworkConfig_NetworkPlugin {
	p := new(ClusterNetworkConfig_NetworkPlugin)
	*p = x
	return p
}

func (x ClusterNetworkConfig_NetworkPlugin) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ClusterNetworkConfig_NetworkPlugin) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_proto_nbcontract_v1_clusterconfig_proto_enumTypes[1].Descriptor()
}

func (ClusterNetworkConfig_NetworkPlugin) Type() protoreflect.EnumType {
	return &file_pkg_proto_nbcontract_v1_clusterconfig_proto_enumTypes[1]
}

func (x ClusterNetworkConfig_NetworkPlugin) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}
...
func (ClusterNetworkConfig_NetworkPlugin) EnumDescriptor() ([]byte, []int) {
	return file_pkg_proto_nbcontract_v1_clusterconfig_proto_rawDescGZIP(), []int{1, 0}
}
...
// Enum value maps for ClusterNetworkConfig_NetworkPolicy.
var (
	ClusterNetworkConfig_NetworkPolicy_name = map[int32]string{
		0: "NPO_UNSPECIFIED",
		1: "NPO_NONE",
		2: "NPO_AZURE",
		3: "NPO_CALICO",
	}
	ClusterNetworkConfig_NetworkPolicy_value = map[string]int32{
		"NPO_UNSPECIFIED": 0,
		"NPO_NONE":        1,
		"NPO_AZURE":       2,
		"NPO_CALICO":      3,
...
func (x ClusterNetworkConfig_NetworkPolicy) Enum() *ClusterNetworkConfig_NetworkPolicy {
	p := new(ClusterNetworkConfig_NetworkPolicy)
	*p = x
	return p
}

func (x ClusterNetworkConfig_NetworkPolicy) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ClusterNetworkConfig_NetworkPolicy) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_proto_nbcontract_v1_clusterconfig_proto_enumTypes[2].Descriptor()
}

func (ClusterNetworkConfig_NetworkPolicy) Type() protoreflect.EnumType {
	return &file_pkg_proto_nbcontract_v1_clusterconfig_proto_enumTypes[2]
}

func (x ClusterNetworkConfig_NetworkPolicy) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}
...
func (ClusterNetworkConfig_NetworkPolicy) EnumDescriptor() ([]byte, []int) {
	return file_pkg_proto_nbcontract_v1_clusterconfig_proto_rawDescGZIP(), []int{1, 1}
}
...
func (LoadBalancerConfig_LoadBalancerSku) Descriptor() protoreflect.EnumDescriptor {
	return file_pkg_proto_nbcontract_v1_clusterconfig_proto_enumTypes[3].Descriptor()
}

func (LoadBalancerConfig_LoadBalancerSku) Type() protoreflect.EnumType {
	return &file_pkg_proto_nbcontract_v1_clusterconfig_proto_enumTypes[3]
}
...
type ClusterNetworkConfig struct {
	...
	NetworkPlugin ClusterNetworkConfig_NetworkPlugin `protobuf:"varint,6,opt,name=network_plugin,json=networkPlugin,proto3,enum=nbcontract.v1.ClusterNetworkConfig_NetworkPlugin" json:"network_plugin,omitempty"`
	...
	NetworkPolicy ClusterNetworkConfig_NetworkPolicy `protobuf:"varint,7,opt,name=network_policy,json=networkPolicy,proto3,enum=nbcontract.v1.ClusterNetworkConfig_NetworkPolicy" json:"network_policy,omitempty"`
...
func (x *ClusterNetworkConfig) GetNetworkPlugin() ClusterNetworkConfig_NetworkPlugin {
	if x != nil {
		return x.NetworkPlugin
	}
	return ClusterNetworkConfig_NP_UNSPECIFIED
}

func (x *ClusterNetworkConfig) GetNetworkPolicy() ClusterNetworkConfig_NetworkPolicy {
	if x != nil {
		return x.NetworkPolicy
	}
	return ClusterNetworkConfig_NPO_UNSPECIFIED
}
...
var file_pkg_proto_nbcontract_v1_clusterconfig_proto_rawDesc = []byte{
	...
	0x53, 0x53, 0x10, 0x02, 0x22, 0xfc, 0x04, 0x0a, 0x14, 0x43, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72,
	...
	,
...
var file_pkg_proto_nbcontract_v1_clusterconfig_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_pkg_proto_nbcontract_v1_clusterconfig_proto_goTypes = []interface{}{
	...
	(ClusterNetworkConfig_NetworkPlugin)(0), // 1: nbcontract.v1.ClusterNetworkConfig.NetworkPlugin
	(ClusterNetworkConfig_NetworkPolicy)(0), // 2: nbcontract.v1.ClusterNetworkConfig.NetworkPolicy
	(LoadBalancerConfig_LoadBalancerSku)(0), // 3: nbcontract.v1.LoadBalancerConfig.LoadBalancerSku
	(*ClusterConfig)(nil),                   // 4: nbcontract.v1.ClusterConfig
	(*ClusterNetworkConfig)(nil),            // 5: nbcontract.v1.ClusterNetworkConfig
...
var file_pkg_proto_nbcontract_v1_clusterconfig_proto_depIdxs = []int32{
	5, // 0: nbcontract.v1.ClusterConfig.cluster_network_config:type_name -> nbcontract.v1.ClusterNetworkConfig
	6, // 1: nbcontract.v1.ClusterConfig.load_balancer_config:type_name -> nbcontract.v1.LoadBalancerConfig
	0, // 2: nbcontract.v1.ClusterConfig.vm_type:type_name -> nbcontract.v1.ClusterConfig.VM
	1, // 3: nbcontract.v1.ClusterNetworkConfig.network_plugin:type_name -> nbcontract.v1.ClusterNetworkConfig.NetworkPlugin
	2, // 4: nbcontract.v1.ClusterNetworkConfig.network_policy:type_name -> nbcontract.v1.ClusterNetworkConfig.NetworkPolicy
	3, // 5: nbcontract.v1.LoadBalancerConfig.load_balancer_sku:type_name -> nbcontract.v1.LoadBalancerConfig.LoadBalancerSku
