...
// linux/cloud-init/artifacts/cse_install.sh_backup
...
var _linuxCloudInitArtifactsCse_installSh_backup = []byte(`#!/bin/bash
...
func linuxCloudInitArtifactsCse_installSh_backupBytes() ([]byte, error) {
	return _linuxCloudInitArtifactsCse_installSh_backup, nil
}

func linuxCloudInitArtifactsCse_installSh_backup() (*asset, error) {
	bytes, err := linuxCloudInitArtifactsCse_installSh_backupBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "linux/cloud-init/artifacts/cse_install.sh_backup", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"linux/cloud-init/artifacts/cse_install.sh_backup":                     linuxCloudInitArtifactsCse_installSh_backup,
	...
	"linux": &bintree{nil, map[string]*bintree{
		"cloud-init": &bintree{nil, map[string]*bintree{
			"artifacts": &bintree{nil, map[string]*bintree{
				...
				"cse_install.sh_backup":                     &bintree{linuxCloudInitArtifactsCse_installSh_backup, map[string]*bintree{}},
