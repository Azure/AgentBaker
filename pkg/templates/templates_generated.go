...
// linux/cloud-init/artifacts/check-outbound-network.service
// linux/cloud-init/artifacts/check-outbound-network.sh
...
var _linuxCloudInitArtifactsCheckOutboundNetworkService = []byte(`[Unit]
Description=Check outbound connectivity from node to certain endpoints

[Service]
Type=oneshot
ExecStart=/bin/bash /opt/scripts/check-outbound-network.sh`)

func linuxCloudInitArtifactsCheckOutboundNetworkServiceBytes() ([]byte, error) {
	return _linuxCloudInitArtifactsCheckOutboundNetworkService, nil
}

func linuxCloudInitArtifactsCheckOutboundNetworkService() (*asset, error) {
	bytes, err := linuxCloudInitArtifactsCheckOutboundNetworkServiceBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "linux/cloud-init/artifacts/check-outbound-network.service", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _linuxCloudInitArtifactsCheckOutboundNetworkSh = []byte(`#!/bin/bash
...
func linuxCloudInitArtifactsCheckOutboundNetworkShBytes() ([]byte, error) {
	return _linuxCloudInitArtifactsCheckOutboundNetworkSh, nil
}

func linuxCloudInitArtifactsCheckOutboundNetworkSh() (*asset, error) {
	bytes, err := linuxCloudInitArtifactsCheckOutboundNetworkShBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "linux/cloud-init/artifacts/check-outbound-network.sh", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"linux/cloud-init/artifacts/check-outbound-network.service":            linuxCloudInitArtifactsCheckOutboundNetworkService,
	"linux/cloud-init/artifacts/check-outbound-network.sh":                 linuxCloudInitArtifactsCheckOutboundNetworkSh,
	...
	"linux": &bintree{nil, map[string]*bintree{
		"cloud-init": &bintree{nil, map[string]*bintree{
			"artifacts": &bintree{nil, map[string]*bintree{
				...
				"check-outbound-network.service":            &bintree{linuxCloudInitArtifactsCheckOutboundNetworkService, map[string]*bintree{}},
				"check-outbound-network.sh":                 &bintree{linuxCloudInitArtifactsCheckOutboundNetworkSh, map[string]*bintree{}},
