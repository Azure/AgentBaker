...
- path: /etc/cron.d/logrotate
  ...
  owner: root
  content: |
    # Used to specify a custom cron schedule for the logrotate service - in this case the middle of every hour
    # /etc/logrotate.conf includes the log rotation configuration within /etc/logrotate.d/rsyslog
