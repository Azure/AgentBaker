...
// linux/cloud-init/artifacts/cni-telemetry.py
// linux/cloud-init/artifacts/cni-telemetry.service
...
var _linuxCloudInitArtifactsCniTelemetryPy = []byte(`#!/usr/bin/env python3
...
func linuxCloudInitArtifactsCniTelemetryPyBytes() ([]byte, error) {
	return _linuxCloudInitArtifactsCniTelemetryPy, nil
}

func linuxCloudInitArtifactsCniTelemetryPy() (*asset, error) {
	bytes, err := linuxCloudInitArtifactsCniTelemetryPyBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "linux/cloud-init/artifacts/cni-telemetry.py", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _linuxCloudInitArtifactsCniTelemetryService = []byte(`[Unit]
Description=Emit CNI telemetry

[Service]
Type=simple
RemainAfterExit=true
Environment="PYTHONUNBUFFERED=1"
ExecStart=/usr/bin/python3 /opt/scripts/cni-telemetry.py

[Install]
WantedBy=multi-user.target
`)

func linuxCloudInitArtifactsCniTelemetryServiceBytes() ([]byte, error) {
	return _linuxCloudInitArtifactsCniTelemetryService, nil
}

func linuxCloudInitArtifactsCniTelemetryService() (*asset, error) {
	bytes, err := linuxCloudInitArtifactsCniTelemetryServiceBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "linux/cloud-init/artifacts/cni-telemetry.service", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"linux/cloud-init/artifacts/cni-telemetry.py":                          linuxCloudInitArtifactsCniTelemetryPy,
	"linux/cloud-init/artifacts/cni-telemetry.service":                     linuxCloudInitArtifactsCniTelemetryService,
	...
	"linux": &bintree{nil, map[string]*bintree{
		"cloud-init": &bintree{nil, map[string]*bintree{
			"artifacts": &bintree{nil, map[string]*bintree{
				...
				"cni-telemetry.py":                          &bintree{linuxCloudInitArtifactsCniTelemetryPy, map[string]*bintree{}},
				"cni-telemetry.service":                     &bintree{linuxCloudInitArtifactsCniTelemetryService, map[string]*bintree{}},
