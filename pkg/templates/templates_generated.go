...
// linux/cloud-init/artifacts/sshd_config_2004_fips
...
var _linuxCloudInitArtifactsSshd_config_2004_fips = []byte(`#	$OpenBSD: sshd_config,v 1.101 2017/03/14 07:19:07 djm Exp $
...
func linuxCloudInitArtifactsSshd_config_2004_fipsBytes() ([]byte, error) {
	return _linuxCloudInitArtifactsSshd_config_2004_fips, nil
}

func linuxCloudInitArtifactsSshd_config_2004_fips() (*asset, error) {
	bytes, err := linuxCloudInitArtifactsSshd_config_2004_fipsBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "linux/cloud-init/artifacts/sshd_config_2004_fips", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"linux/cloud-init/artifacts/sshd_config_2004_fips":                     linuxCloudInitArtifactsSshd_config_2004_fips,
	...
	"linux": &bintree{nil, map[string]*bintree{
		"cloud-init": &bintree{nil, map[string]*bintree{
			"artifacts": &bintree{nil, map[string]*bintree{
				...
				"sshd_config_2004_fips":           &bintree{linuxCloudInitArtifactsSshd_config_2004_fips, map[string]*bintree{}},
