...
$global:EnableIncreaseDynamicPortRange = [System.Convert]::ToBoolean("{{GetEnableIncreaseDynamicPortRange}}");
...
try
{
    ...
    $WindowsCSEScriptsPackage = "aks-windows-cse-scripts-v0.0.17.zip"
