...
// linux/cloud-init/artifacts/aks-local-dns.slice
...
var _linuxCloudInitArtifactsAksLocalDnsPrestartSh = []byte(`#! /bin/bash
...
func linuxCloudInitArtifactsAksLocalDnsPrestartShBytes() ([]byte, error) {
	return _linuxCloudInitArtifactsAksLocalDnsPrestartSh, nil
}

func linuxCloudInitArtifactsAksLocalDnsPrestartSh() (*asset, error) {
	bytes, err := linuxCloudInitArtifactsAksLocalDnsPrestartShBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "linux/cloud-init/artifacts/aks-local-dns-prestart.sh", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func linuxCloudInitArtifactsAksLocalDnsResolvedConf() (*asset, error) {
	bytes, err := linuxCloudInitArtifactsAksLocalDnsResolvedConfBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "linux/cloud-init/artifacts/aks-local-dns-resolved.conf", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _linuxCloudInitArtifactsAksLocalDnsDefault = []byte(`#######################################################################
...
func linuxCloudInitArtifactsAksLocalDnsDefault() (*asset, error) {
	bytes, err := linuxCloudInitArtifactsAksLocalDnsDefaultBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "linux/cloud-init/artifacts/aks-local-dns.default", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _linuxCloudInitArtifactsAksLocalDnsService = []byte(`[Unit]
...
func linuxCloudInitArtifactsAksLocalDnsService() (*asset, error) {
	bytes, err := linuxCloudInitArtifactsAksLocalDnsServiceBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "linux/cloud-init/artifacts/aks-local-dns.service", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _linuxCloudInitArtifactsAksLocalDnsSh = []byte(`#! /bin/bash
set -euo pipefail
...
func linuxCloudInitArtifactsAksLocalDnsSh() (*asset, error) {
	bytes, err := linuxCloudInitArtifactsAksLocalDnsShBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "linux/cloud-init/artifacts/aks-local-dns.sh", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}

var _linuxCloudInitArtifactsAksLocalDnsSlice = []byte(`[Unit]
...
func linuxCloudInitArtifactsAksLocalDnsSliceBytes() ([]byte, error) {
	return _linuxCloudInitArtifactsAksLocalDnsSlice, nil
}

func linuxCloudInitArtifactsAksLocalDnsSlice() (*asset, error) {
	bytes, err := linuxCloudInitArtifactsAksLocalDnsSliceBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "linux/cloud-init/artifacts/aks-local-dns.slice", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"linux/cloud-init/artifacts/aks-local-dns.slice":                       linuxCloudInitArtifactsAksLocalDnsSlice,
	...
	"linux": &bintree{nil, map[string]*bintree{
		"cloud-init": &bintree{nil, map[string]*bintree{
			"artifacts": &bintree{nil, map[string]*bintree{
				...
				"aks-local-dns.slice":                       &bintree{linuxCloudInitArtifactsAksLocalDnsSlice, map[string]*bintree{}},
