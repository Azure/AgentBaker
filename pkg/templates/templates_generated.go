...
var _linuxCloudInitArtifactsCgroupMemoryTelemetrySh = []byte(`# shellcheck shell=bash
...
var _linuxCloudInitArtifactsCgroupPressureTelemetrySh = []byte(`# shellcheck shell=bash
