...
export NVIDIA_DRIVER_IMAGE_SHA="sha256:4e003f2e3f042adcac5f854e2591564cff6b5983f79da4d22eba70a47a43efc8"
# export NVIDIA_DRIVER_IMAGE_TAG="${GPU_DV}-${NVIDIA_DRIVER_IMAGE_SHA}"
export NVIDIA_DRIVER_IMAGE_TAG="latest"
# export NVIDIA_DRIVER_IMAGE="mcr.microsoft.com/aks/aks-gpu"
export NVIDIA_DRIVER_IMAGE="docker.io/utheman/aks-gpu"
