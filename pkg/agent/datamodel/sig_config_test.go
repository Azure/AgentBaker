...
var _ = Describe("GetSIGAzureCloudSpecConfig", func() {
	...
	It("should return correct value", func() {
		...
		Expect(aksUbuntuGPU1804Gen2.Version).To(Equal("2022.06.13"))
		...
		Expect(mariner.Version).To(Equal("2022.06.13"))
		...
		Expect(windows2019.Version).To(Equal("17763.3046.220615"))
		...
		Expect(windows2019Containerd.Version).To(Equal("17763.3046.220615"))
		...
		Expect(windows2022Containerd.Version).To(Equal("20348.768.220615"))
