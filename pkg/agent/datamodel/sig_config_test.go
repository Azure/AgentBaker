...
var _ = Describe("GetSIGAzureCloudSpecConfig", func() {
	...
	It("should return correct value", func() {
		...
		Expect(aksUbuntuGPU1804Gen2.Version).To(Equal("2022.09.05"))
		...
		Expect(mariner.Version).To(Equal("2022.09.05"))
		...
		Expect(aksUbuntu2004CVMGen2Containerd.Version).To(Equal("2022.09.05"))
