...
var _ = Describe("GetSIGAzureCloudSpecConfig", func() {
	...
	It("should return correct value", func() {
		...
		Expect(azurelinux.Version).To(Equal(FrozenAzureLinuxSIGImageVersion))
		...
		Expect(marinerV2Arm64.Version).To(Equal(FrozenCBLMarinerLinuxSIGImageVersion))
		...
		Expect(azurelinuxV2Arm64.Version).To(Equal(FrozenAzureLinuxSIGImageVersion))
		...
		Expect(marinerV2Gen2TL.Version).To(Equal(FrozenCBLMarinerLinuxSIGImageVersion))
		...
		Expect(azurelinuxV2Gen2TL.Version).To(Equal(FrozenAzureLinuxSIGImageVersion))
		...
		Expect(marinerV2FIPS.Version).To(Equal(FrozenCBLMarinerLinuxSIGImageVersion))
		...
		Expect(azurelinuxV2FIPS.Version).To(Equal(FrozenAzureLinuxSIGImageVersion))
		...
		Expect(marinerV2Gen2FIPS.Version).To(Equal(FrozenCBLMarinerLinuxSIGImageVersion))
		...
		Expect(azurelinuxV2Gen2FIPS.Version).To(Equal(FrozenAzureLinuxSIGImageVersion))
