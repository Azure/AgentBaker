...
var _ = Describe("GetSIGAzureCloudSpecConfig", func() {
	...
	It("should return correct value", func() {
		...
		Expect(mariner.Version).To(Equal("2022.10.03"))
		...
		Expect(aksUbuntu2204Containerd.Version).To(Equal("2022.10.03"))
		...
		Expect(aksUbuntu2204Gen2Containerd.Version).To(Equal("2022.10.03"))
		...
		Expect(aksUbuntu2004CVMGen2Containerd.Version).To(Equal("2022.10.03"))
