...
var _ = Describe("GetSIGAzureCloudSpecConfig", func() {
	...
	It("should return correct value", func() {
		...
		Expect(mariner.Version).To(Equal("2022.08.29"))
		...
		Expect(windows2019.Version).To(Equal("17763.3406.220914"))
		...
		Expect(windows2019Containerd.Version).To(Equal("17763.3406.220914"))
		...
		Expect(windows2022Containerd.Version).To(Equal("20348.1006.220914"))
		...
		Expect(windows2022ContainerdGen2.Version).To(Equal("20348.1006.220914"))
		...
		Expect(aksUbuntuArm641804Gen2.Version).To(Equal(Arm64LinuxSIGImageVersion))
		...
		Expect(aksUbuntuArm642204Gen2.Version).To(Equal(Arm64LinuxSIGImageVersion))
		...
		Expect(aksUbuntu2204Containerd.Version).To(Equal("2022.07.25"))
		...
		Expect(aksUbuntu2204Gen2Containerd.Version).To(Equal("2022.07.25"))
		...
		Expect(aksUbuntu2004CVMGen2Containerd.Version).To(Equal("2022.08.29"))
