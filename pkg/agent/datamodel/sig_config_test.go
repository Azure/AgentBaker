...
var _ = Describe("GetSIGAzureCloudSpecConfig", func() {
	...
	It("should return correct value", func() {
		...
		Expect(aksUbuntu2204Containerd.Version).To(Equal("2022.12.06"))
		...
		Expect(aksUbuntu2204Gen2Containerd.Version).To(Equal("2022.12.06"))
		...
		Expect(aksUbuntu2004CVMGen2Containerd.Version).To(Equal("2022.12.06"))
