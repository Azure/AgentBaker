...
var _ = Describe("GetSIGAzureCloudSpecConfig", func() {
	...
	It("should return correct value", func() {
		...
		Expect(mariner.Version).To(Equal("2022.11.02"))
		...
		Expect(windows2019.Version).To(Equal("17763.3650.221110"))
		...
		Expect(windows2019Containerd.Version).To(Equal("17763.3650.221110"))
		...
		Expect(windows2022Containerd.Version).To(Equal("20348.1249.221110"))
		...
		Expect(windows2022ContainerdGen2.Version).To(Equal("20348.1249.221110"))
		...
		Expect(aksUbuntu2204Containerd.Version).To(Equal("2022.11.02"))
		...
		Expect(aksUbuntu2204Gen2Containerd.Version).To(Equal("2022.11.02"))
		...
		Expect(aksUbuntu2004CVMGen2Containerd.Version).To(Equal("2022.11.02"))
