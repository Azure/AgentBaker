...
var _ = Describe("GetSIGAzureCloudSpecConfig", func() {
	...
	It("should return correct value", func() {
		...
		Expect(aksUbuntuGPU1804Gen2.Version).To(Equal("2022.01.08"))
		...
		Expect(mariner.Version).To(Equal("2022.01.08"))
		...
		Expect(windows2019Containerd.Version).To(Equal("17763.2366.220117"))
