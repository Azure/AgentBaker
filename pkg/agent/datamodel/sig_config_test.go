...
var _ = Describe("GetSIGAzureCloudSpecConfig", func() {
	...
	It("should return correct value", func() {
		...
		Expect(aksUbuntuGPU1804Gen2.Version).To(Equal("2022.07.04"))
		...
		Expect(mariner.Version).To(Equal("2022.07.04"))
		...
		Expect(windows2019.Version).To(Equal("17763.3046.220624"))
		...
		Expect(windows2019Containerd.Version).To(Equal("17763.3046.220624"))
		...
		Expect(windows2022Containerd.Version).To(Equal("20348.768.220624"))
