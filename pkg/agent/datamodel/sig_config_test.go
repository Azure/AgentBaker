...
var _ = Describe("GetSIGAzureCloudSpecConfig", func() {
	...
	It("should return correct value", func() {
		...
		Expect(len(sigConfig.SigCBLMarinerImageConfig)).To(Equal(6))
		...
		Expect(mariner.Version).To(Equal("2023.01.19"))
		...
		Expect(aksUbuntu2204Containerd.Version).To(Equal(Ubuntu2204MinimalSIGImageVersion))
		...
		Expect(aksUbuntu2204Gen2Containerd.Version).To(Equal(Ubuntu2204MinimalSIGImageVersion))
		...
		Expect(aksUbuntu2004CVMGen2Containerd.Version).To(Equal("2023.01.19"))
		...
		Expect(aksUbuntu2204TLGen2Containerd.Version).To(Equal(Ubuntu2204MinimalSIGImageVersion))
