...
var _ = Describe("GetSIGAzureCloudSpecConfig", func() {
	...
	It("should return correct value", func() {
		...
		Expect(aksUbuntuGPU1804Gen2.Version).To(Equal("2022.08.23"))
		...
		Expect(mariner.Version).To(Equal("2022.08.23"))
		...
		Expect(windows2022ContainerdGen2.Version).To(Equal("20348.887.220810"))
		...
		Expect(aksUbuntu2004CVMGen2Containerd.Version).To(Equal("2022.08.23"))
