...
var _ = Describe("GetSIGAzureCloudSpecConfig", func() {
	...
	It("should return correct value", func() {
		...
		Expect(windows2019.Version).To(Equal("17763.3650.221109"))
		...
		Expect(windows2019Containerd.Version).To(Equal("17763.3650.221109"))
		...
		Expect(windows2022Containerd.Version).To(Equal("20348.1249.221109"))
		...
		Expect(windows2022ContainerdGen2.Version).To(Equal("20348.1249.221109"))
