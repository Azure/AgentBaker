...
var _ = Describe("GetSIGAzureCloudSpecConfig", func() {
	...
	It("should return correct value", func() {
		...
		Expect(aksUbuntuGPU1804Gen2.Version).To(Equal("3030.40.50"))
		...
		Expect(mariner.Version).To(Equal("3030.40.50"))
		...
		Expect(windows2019Containerd.Version).To(Equal("17763.2300.211110"))
	})
})
