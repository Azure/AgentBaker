...
var AvailableUbuntu2404Distros = []Distro{
	...
	AKSUbuntuGB200Arm64Containerd2404Gen2,
...
var (
	...
	SIGUbuntuGB200Arm64Containerd2404Gen2ImageConfigTemplate = SigImageConfigTemplate{
		ResourceGroup: AKSUbuntuResourceGroup,
		Gallery:       AKSUbuntuGalleryName,
		Definition:    "2404gb200arm64gen2containerd",
		Version:       LinuxSIGImageVersion,
	}
...
func getSigUbuntuImageConfigMapWithOpts(opts ...SigImageConfigOpt) map[Distro]SigImageConfig {
	return map[Distro]SigImageConfig{
		...
		AKSUbuntuGB200Arm64Containerd2404Gen2: SIGUbuntuGB200Arm64Containerd2404Gen2ImageConfigTemplate.WithOptions(opts...),
