...
var k8sComponentVersions = map[string]map[string]string{
	"1.19": {
		...
		ClusterAutoscalerAddonName: "cluster-autoscaler:v1.18.0",
	},
	"1.18": {
		"addon-resizer":            "addon-resizer:1.8.7",
	...
	"1.17": {
		...
		"metrics-server":           "metrics-server-amd64:v0.3.5",
		"addon-manager":            "kube-addon-manager-amd64:v9.0.2",
		ClusterAutoscalerAddonName: "cluster-autoscaler:v1.17.0",
	},
	"1.16": {
		"addon-resizer":            "addon-resizer:1.8.7",
		"metrics-server":           "metrics-server-amd64:v0.3.4",
		"addon-manager":            "kube-addon-manager-amd64:v9.0.2",
		ClusterAutoscalerAddonName: "cluster-autoscaler:v1.16.3",
	},
	"1.15": {
		"addon-resizer":            "addon-resizer:1.8.7",
		"metrics-server":           "metrics-server-amd64:v0.2.1",
		"addon-manager":            "kube-addon-manager-amd64:v9.0.2",
		ClusterAutoscalerAddonName: "cluster-autoscaler:v1.15.4",
	},
	"1.14": {
		"addon-resizer":            "addon-resizer:1.8.4",
		"metrics-server":           "metrics-server-amd64:v0.2.1",
		"addon-manager":            "kube-addon-manager-amd64:v9.0.2",
		ClusterAutoscalerAddonName: "cluster-autoscaler:v1.14.7",
	},
	"1.13": {
		"addon-resizer":            "addon-resizer:1.8.4",
		"metrics-server":           "metrics-server-amd64:v0.2.1",
		"addon-manager":            "kube-addon-manager-amd64:v8.9.1",
		ClusterAutoscalerAddonName: "cluster-autoscaler:v1.13.9",
	},
	"1.12": {
		"addon-resizer":            "addon-resizer:1.8.4",
		"metrics-server":           "metrics-server-amd64:v0.2.1",
		"addon-manager":            "kube-addon-manager-amd64:v8.9.1",
		ClusterAutoscalerAddonName: "cluster-autoscaler:v1.12.8",
	},
	"1.11": {
		"addon-resizer":            "addon-resizer:1.8.4",
		"metrics-server":           "metrics-server-amd64:v0.2.1",
		"addon-manager":            "kube-addon-manager-amd64:v8.9.1",
		ClusterAutoscalerAddonName: "cluster-autoscaler:v1.3.9",
	},
	"1.10": {
		"addon-resizer":             "addon-resizer:1.8.4",
		"metrics-server":            "metrics-server-amd64:v0.2.1",
		...
		ClusterAutoscalerAddonName:  "cluster-autoscaler:v1.2.5",
	...
	"1.9": {
		...
		"rescheduler":              "rescheduler:v0.3.1",
		ClusterAutoscalerAddonName: "cluster-autoscaler:v1.1.2",
...
func getKubeConfigs() map[string]map[string]string {
	...
	for _, version := range GetAllSupportedKubernetesVersions(true, false) {
...
func getK8sVersionComponents(version string, overrides map[string]string) map[string]string {
	...
	case "1.19":
		ret = map[string]string{
			...
			KubeProxyAddonName:                         "kube-proxy:v" + version,
			"kube-scheduler":                           "kube-scheduler:v" + version,
			"ccm":                                      azureCloudControllerManagerImageReference,
			CloudNodeManagerAddonName:                  azureCloudNodeManagerImageReference,
			"windowszip":                               "v" + version + "/windowszip/v" + version + "-1int.zip",
			DashboardAddonName:                         dashboardImageReference,
			...
			CoreDNSAddonName:                           coreDNSImageReference,
			...
			TillerAddonName:                            tillerImageReference,
			ReschedulerAddonName:                       reschedulerImageReference,
			ACIConnectorAddonName:                      virtualKubeletImageReference,
			ContainerMonitoringAddonName:               omsImageReference,
			AzureCNINetworkMonitorAddonName:            azureCNINetworkMonitorImageReference,
			ClusterAutoscalerAddonName:                 k8sComponent[ClusterAutoscalerAddonName],
			"k8s-dns-sidecar":                          kubeDNSSidecarImageReference,
			BlobfuseFlexVolumeAddonName:                blobfuseFlexVolumeImageReference,
			SMBFlexVolumeAddonName:                     smbFlexVolumeImageReference,
			KeyVaultFlexVolumeAddonName:                keyvaultFlexVolumeImageReference,
			IPMASQAgentAddonName:                       ipMasqAgentImageReference,
			DNSAutoscalerAddonName:                     dnsAutoscalerImageReference,
			AzureNetworkPolicyAddonName:                azureNPMContainerImageReference,
			...
			CiliumAgentContainerName:                   ciliumAgentImageReference,
			CiliumCleanStateContainerName:              ciliumCleanStateImageReference,
			CiliumOperatorContainerName:                ciliumOperatorImageReference,
			CiliumEtcdOperatorContainerName:            ciliumEtcdOperatorImageReference,
			AntreaControllerContainerName:              antreaControllerImageReference,
			AntreaAgentContainerName:                   antreaAgentImageReference,
			AntreaOVSContainerName:                     antreaOVSImageReference,
			"antrea" + AntreaInstallCNIContainerName:   antreaInstallCNIImageReference,
			NMIContainerName:                           aadPodIdentityNMIImageReference,
			MICContainerName:                           aadPodIdentityMICImageReference,
			AzurePolicyAddonName:                       azurePolicyImageReference,
			GatekeeperContainerName:                    gatekeeperImageReference,
			NodeProblemDetectorAddonName:               nodeProblemDetectorImageReference,
			CSIProvisionerContainerName:                csiProvisionerImageReference,
			CSIAttacherContainerName:                   csiAttacherImageReference,
			CSIClusterDriverRegistrarContainerName:     csiClusterDriverRegistrarImageReference,
			CSILivenessProbeContainerName:              csiLivenessProbeImageReference,
			CSINodeDriverRegistrarContainerName:        csiNodeDriverRegistrarImageReference,
			CSISnapshotterContainerName:                csiSnapshotterImageReference,
			CSIResizerContainerName:                    csiResizerImageReference,
			CSIAzureDiskContainerName:                  csiAzureDiskImageReference,
			CSIAzureFileContainerName:                  csiAzureFileImageReference,
			KubeFlannelContainerName:                   kubeFlannelImageReference,
			"flannel" + FlannelInstallCNIContainerName: flannelInstallCNIImageReference,
			KubeRBACProxyContainerName:                 KubeRBACProxyImageReference,
			ScheduledMaintenanceManagerContainerName:   ScheduledMaintenanceManagerImageReference,
			...
			NVIDIADevicePluginAddonName:                nvidiaDevicePluginImageReference,
		}
	case "1.18":
		ret = map[string]string{
			"kube-apiserver":                           "kube-apiserver:v" + version,
	...
	case "1.16":
		ret = map[string]string{
			...
			KubeProxyAddonName:                         "hyperkube-amd64:v" + version,
			"ccm":                                      azureCloudControllerManagerImageReference,
			CloudNodeManagerAddonName:                  azureCloudNodeManagerImageReference,
			"windowszip":                               "v" + version + "/windowszip/v" + version + "-1int.zip",
			DashboardAddonName:                         dashboardImageReference,
