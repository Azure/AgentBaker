...
var k8sComponentVersions = map[string]map[string]string{
	"1.19": {
		...
		"metrics-server":                     "metrics-server/metrics-server:v0.3.7",
		"addon-manager":                      "kube-addon-manager-amd64:v9.1.1",
		datamodel.ClusterAutoscalerAddonName: "cluster-autoscaler:v1.18.0",
	},
	"1.18": {
		"addon-resizer":                      "addon-resizer:1.8.7",
	...
	"1.17": {
		...
		"metrics-server":                     "metrics-server-amd64:v0.3.5",
		"addon-manager":                      "kube-addon-manager-amd64:v9.0.2",
		datamodel.ClusterAutoscalerAddonName: "cluster-autoscaler:v1.17.0",
	},
	"1.16": {
		"addon-resizer":                      "addon-resizer:1.8.7",
		"metrics-server":                     "metrics-server-amd64:v0.3.4",
		"addon-manager":                      "kube-addon-manager-amd64:v9.0.2",
		datamodel.ClusterAutoscalerAddonName: "cluster-autoscaler:v1.16.3",
	},
	"1.15": {
		"addon-resizer":                      "addon-resizer:1.8.7",
		"metrics-server":                     "metrics-server-amd64:v0.2.1",
		"addon-manager":                      "kube-addon-manager-amd64:v9.0.2",
		datamodel.ClusterAutoscalerAddonName: "cluster-autoscaler:v1.15.4",
	},
	"1.14": {
		"addon-resizer":                      "addon-resizer:1.8.4",
		"metrics-server":                     "metrics-server-amd64:v0.2.1",
		"addon-manager":                      "kube-addon-manager-amd64:v9.0.2",
		datamodel.ClusterAutoscalerAddonName: "cluster-autoscaler:v1.14.7",
	},
	"1.13": {
		"addon-resizer":                      "addon-resizer:1.8.4",
		"metrics-server":                     "metrics-server-amd64:v0.2.1",
		"addon-manager":                      "kube-addon-manager-amd64:v8.9.1",
		datamodel.ClusterAutoscalerAddonName: "cluster-autoscaler:v1.13.9",
	},
	"1.12": {
		"addon-resizer":                      "addon-resizer:1.8.4",
		"metrics-server":                     "metrics-server-amd64:v0.2.1",
		"addon-manager":                      "kube-addon-manager-amd64:v8.9.1",
		datamodel.ClusterAutoscalerAddonName: "cluster-autoscaler:v1.12.8",
	},
	"1.11": {
		"addon-resizer":                      "addon-resizer:1.8.4",
		"metrics-server":                     "metrics-server-amd64:v0.2.1",
		"addon-manager":                      "kube-addon-manager-amd64:v8.9.1",
		datamodel.ClusterAutoscalerAddonName: "cluster-autoscaler:v1.3.9",
	},
	"1.10": {
		"addon-resizer":                       "addon-resizer:1.8.4",
		"metrics-server":                      "metrics-server-amd64:v0.2.1",
		...
		datamodel.ClusterAutoscalerAddonName:  "cluster-autoscaler:v1.2.5",
		datamodel.NVIDIADevicePluginAddonName: "k8s-device-plugin:1.10",
	...
	"1.9": {
		...
		"rescheduler":                        "rescheduler:v0.3.1",
		datamodel.ClusterAutoscalerAddonName: "cluster-autoscaler:v1.1.2",
...
func getK8sVersionComponents(version string, overrides map[string]string) map[string]string {
	...
	case "1.19":
		ret = map[string]string{
			...
			datamodel.KubeProxyAddonName:                         "kube-proxy:v" + version,
			"kube-scheduler":                                     "kube-scheduler:v" + version,
			"ccm":                                                azureCloudControllerManagerImageReference,
			datamodel.CloudNodeManagerAddonName:                  azureCloudNodeManagerImageReference,
			"windowszip":                                         "v" + version + "/windowszip/v" + version + "-1int.zip",
			datamodel.DashboardAddonName:                         dashboardImageReference,
			"exechealthz":                                        execHealthZImageReference,
			"addonresizer":                                       k8sComponent["addon-resizer"],
			"heapster":                                           heapsterImageReference,
			datamodel.MetricsServerAddonName:                     k8sComponent["metrics-server"],
			datamodel.CoreDNSAddonName:                           coreDNSImageReference,
			...
			datamodel.TillerAddonName:                            tillerImageReference,
			datamodel.ReschedulerAddonName:                       reschedulerImageReference,
			ACIConnectorAddonName:                                virtualKubeletImageReference,
			datamodel.ContainerMonitoringAddonName:               omsImageReference,
			datamodel.AzureCNINetworkMonitorAddonName:            azureCNINetworkMonitorImageReference,
			datamodel.ClusterAutoscalerAddonName:                 k8sComponent[datamodel.ClusterAutoscalerAddonName],
			"k8s-dns-sidecar":                                    kubeDNSSidecarImageReference,
			datamodel.BlobfuseFlexVolumeAddonName:                blobfuseFlexVolumeImageReference,
			datamodel.SMBFlexVolumeAddonName:                     smbFlexVolumeImageReference,
			datamodel.KeyVaultFlexVolumeAddonName:                keyvaultFlexVolumeImageReference,
			datamodel.IPMASQAgentAddonName:                       ipMasqAgentImageReference,
			datamodel.DNSAutoscalerAddonName:                     dnsAutoscalerImageReference,
			datamodel.AzureNetworkPolicyAddonName:                azureNPMContainerImageReference,
			...
			datamodel.CiliumAgentContainerName:                   ciliumAgentImageReference,
			datamodel.CiliumCleanStateContainerName:              ciliumCleanStateImageReference,
			datamodel.CiliumOperatorContainerName:                ciliumOperatorImageReference,
			datamodel.CiliumEtcdOperatorContainerName:            ciliumEtcdOperatorImageReference,
			datamodel.AntreaControllerContainerName:              antreaControllerImageReference,
			datamodel.AntreaAgentContainerName:                   antreaAgentImageReference,
			datamodel.AntreaOVSContainerName:                     antreaOVSImageReference,
			"antrea" + datamodel.AntreaInstallCNIContainerName:   antreaInstallCNIImageReference,
			datamodel.NMIContainerName:                           aadPodIdentityNMIImageReference,
			datamodel.MICContainerName:                           aadPodIdentityMICImageReference,
			datamodel.AzurePolicyAddonName:                       azurePolicyImageReference,
			datamodel.GatekeeperContainerName:                    gatekeeperImageReference,
			datamodel.NodeProblemDetectorAddonName:               nodeProblemDetectorImageReference,
			datamodel.CSIProvisionerContainerName:                csiProvisionerImageReference,
			datamodel.CSIAttacherContainerName:                   csiAttacherImageReference,
			datamodel.CSIClusterDriverRegistrarContainerName:     csiClusterDriverRegistrarImageReference,
			datamodel.CSILivenessProbeContainerName:              csiLivenessProbeImageReference,
			datamodel.CSINodeDriverRegistrarContainerName:        csiNodeDriverRegistrarImageReference,
			datamodel.CSISnapshotterContainerName:                csiSnapshotterImageReference,
			datamodel.CSIResizerContainerName:                    csiResizerImageReference,
			datamodel.CSIAzureDiskContainerName:                  csiAzureDiskImageReference,
			datamodel.CSIAzureFileContainerName:                  csiAzureFileImageReference,
			datamodel.KubeFlannelContainerName:                   kubeFlannelImageReference,
			"flannel" + datamodel.FlannelInstallCNIContainerName: flannelInstallCNIImageReference,
			datamodel.KubeRBACProxyContainerName:                 KubeRBACProxyImageReference,
			datamodel.ScheduledMaintenanceManagerContainerName:   ScheduledMaintenanceManagerImageReference,
			"nodestatusfreq":                                     datamodel.DefaultKubernetesNodeStatusUpdateFrequency,
			"nodegraceperiod":                                    datamodel.DefaultKubernetesCtrlMgrNodeMonitorGracePeriod,
			"podeviction":                                        datamodel.DefaultKubernetesCtrlMgrPodEvictionTimeout,
			"routeperiod":                                        datamodel.DefaultKubernetesCtrlMgrRouteReconciliationPeriod,
			"backoffretries":                                     strconv.Itoa(datamodel.DefaultKubernetesCloudProviderBackoffRetries),
			"backoffjitter":                                      strconv.FormatFloat(datamodel.DefaultKubernetesCloudProviderBackoffJitter, 'f', -1, 64),
			"backoffduration":                                    strconv.Itoa(datamodel.DefaultKubernetesCloudProviderBackoffDuration),
			"backoffexponent":                                    strconv.FormatFloat(datamodel.DefaultKubernetesCloudProviderBackoffExponent, 'f', -1, 64),
			"ratelimitqps":                                       strconv.FormatFloat(datamodel.DefaultKubernetesCloudProviderRateLimitQPS, 'f', -1, 64),
			"ratelimitqpswrite":                                  strconv.FormatFloat(datamodel.DefaultKubernetesCloudProviderRateLimitQPSWrite, 'f', -1, 64),
			"ratelimitbucket":                                    strconv.Itoa(datamodel.DefaultKubernetesCloudProviderRateLimitBucket),
			"ratelimitbucketwrite":                               strconv.Itoa(datamodel.DefaultKubernetesCloudProviderRateLimitBucketWrite),
			"gchighthreshold":                                    strconv.Itoa(datamodel.DefaultKubernetesGCHighThreshold),
			"gclowthreshold":                                     strconv.Itoa(datamodel.DefaultKubernetesGCLowThreshold),
			datamodel.NVIDIADevicePluginAddonName:                nvidiaDevicePluginImageReference,
		}
	case "1.18":
		ret = map[string]string{
			"kube-apiserver":                                     "kube-apiserver:v" + version,
			...
			datamodel.TillerAddonName:                            tillerImageReference,
			datamodel.ReschedulerAddonName:                       reschedulerImageReference,
			datamodel.ACIConnectorAddonName:                      virtualKubeletImageReference,
			datamodel.ContainerMonitoringAddonName:               omsImageReference,
			datamodel.AzureCNINetworkMonitorAddonName:            azureCNINetworkMonitorImageReference,
			datamodel.ClusterAutoscalerAddonName:                 k8sComponent[datamodel.ClusterAutoscalerAddonName],
			"k8s-dns-sidecar":                                    kubeDNSSidecarImageReference,
	...
	case "1.16":
		ret = map[string]string{
			...
			datamodel.KubeProxyAddonName:                         "hyperkube-amd64:v" + version,
			"ccm":                                                azureCloudControllerManagerImageReference,
			datamodel.CloudNodeManagerAddonName:                  azureCloudNodeManagerImageReference,
			"windowszip":                                         "v" + version + "/windowszip/v" + version + "-1int.zip",
			datamodel.DashboardAddonName:                         dashboardImageReference,
	...
	case "1.10":
		ret = map[string]string{
			...
			"pause":                                pauseImageReference,
			datamodel.TillerAddonName:              tillerImageReference,
			datamodel.ReschedulerAddonName:         k8sComponent["rescheduler"],
			ACIConnectorAddonName:                  virtualKubeletImageReference,
			datamodel.ContainerMonitoringAddonName: omsImageReference,
			datamodel.AzureCNINetworkMonitorAddonName:            azureCNINetworkMonitorImageReference,
			datamodel.ClusterAutoscalerAddonName:                 k8sComponent[datamodel.ClusterAutoscalerAddonName],
			...
			"gchighthreshold":                                    strconv.Itoa(datamodel.DefaultKubernetesGCHighThreshold),
			"gclowthreshold":                                     strconv.Itoa(datamodel.DefaultKubernetesGCLowThreshold),
			datamodel.NVIDIADevicePluginAddonName:                k8sComponent[datamodel.NVIDIADevicePluginAddonName],
		}
	case "1.9":
		ret = map[string]string{
			"hyperkube":                            "hyperkube-amd64:v" + version,
	...
	case "1.7":
		ret = map[string]string{
			"hyperkube":                               "hyperkube-amd64:v" + version,
			datamodel.KubeProxyAddonName:              "hyperkube-amd64:v" + version,
			datamodel.DashboardAddonName:              k8sComponent["dashboard"],
			"exechealthz":                             execHealthZImageReference,
			"addonresizer":                            k8sComponent["addon-resizer"],
			"heapster":                                k8sComponent["heapster"],
			datamodel.MetricsServerAddonName:          k8sComponent["metrics-server"],
