...
var _ = Describe("Assert generated customData and cseCmd", func() {
	DescribeTable("Generated customData and CSE", func(folder, k8sVersion string, configUpdator func(*datamodel.NodeBootstrappingConfiguration)) {
		...
		Entry("AKSUbuntu1804 with containerd and kubenet cni and multiple vnets", "AKSUbuntu1804+Containerd+Kubenet+MultipleVnets", "1.18.2", func(config *datamodel.NodeBootstrappingConfiguration) {
			config.ContainerService.Properties.AgentPoolProfiles[0].KubernetesConfig = &datamodel.KubernetesConfig{
				KubeletConfig:    map[string]string{},
				ContainerRuntime: datamodel.Containerd,
			}
		...
		Entry("AKSUbuntu1804 with containerd and kubenet cni and ipmasqagent", "AKSUbuntu1804+Containerd+Kubenet+ipmasqagent", "1.18.2", func(config *datamodel.NodeBootstrappingConfiguration) {
			config.ContainerService.Properties.AgentPoolProfiles[0].KubernetesConfig = &datamodel.KubernetesConfig{
				KubeletConfig:    map[string]string{},
				ContainerRuntime: datamodel.Containerd,
			}
			...
			config.ContainerService.Properties.HostedMasterProfile = nil
		}),
