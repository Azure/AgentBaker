...
var _ = Describe("nvidia sku checks", func() {
	It("isStandardNCT4v3 should return true", func() {
		Expect(isStandardNCT4v3("Standard_NC4as_T4_v3")).To(BeTrue())
		Expect(isStandardNCT4v3("standard_nc4as_t4_v3")).To(BeTrue())

		Expect(isStandardNCT4v3("Standard_NC8as_T4_v3")).To(BeTrue())
		Expect(isStandardNCT4v3("standard_nc8as_t4_v3")).To(BeTrue())

		Expect(isStandardNCT4v3("Standard_NC16as_T4_v3")).To(BeTrue())
		Expect(isStandardNCT4v3("standard_nc16as_t4_v3")).To(BeTrue())

		Expect(isStandardNCT4v3("Standard_NC64as_T4_v3")).To(BeTrue())
		Expect(isStandardNCT4v3("standard_nc64as_t4_v3")).To(BeTrue())
	...
	It("isStandardNCT4v3 should return false", func() {
		Expect(isStandardNCT4v3("standard_D4s_v3")).To(BeFalse())
		Expect(isStandardNCT4v3("Standard_NC6")).To(BeFalse())
	})

	It("isStandardNCv1 should return true", func() {
		Expect(isStandardNCv1("Standard_NC6")).To(BeTrue())
		Expect(isStandardNCv1("standard_nc6")).To(BeTrue())
		Expect(isStandardNCv1("Standard_Nc6")).To(BeTrue())
	})

	It("isStandardNCv1 should return false", func() {
		Expect(isStandardNCv1("standard_D4s_v3")).To(BeFalse())
		Expect(isStandardNCv1("Standard_NC64as_T4_v3")).To(BeFalse())
	})
})
