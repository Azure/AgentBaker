...
func getCustomDataVariables(config *datamodel.NodeBootstrappingConfiguration) paramsMap {
	...
	cloudInitFiles := map[string]interface{}{
		"cloudInitData": paramsMap{
			...
			"downloadSecureTLSBootstrapClientScript":  getBase64EncodedGzippedCustomScript(downloadSecureTLSBootstrapClientScript, config),
			"downloadSecureTLSBootstrapClientService": getBase64EncodedGzippedCustomScript(downloadSecureTLSBootstrapClientService, config),
