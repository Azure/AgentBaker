...
const (
	...
	kubernetesCSEBenchmarkHelpersScript = "linux/cloud-init/artifacts/cse_benchmark_functions.sh" // HERE
...
const (
	...
	cseBenchmarkHelpersScriptFilepath    = "/opt/azure/containers/provision_source_benchmarks.sh"
