...
const (
	...
	downloadSecureTLSBootstrapClientScript  = "linux/cloud-init/artifacts/download-secure-tls-bootstrap-client.sh"
	downloadSecureTLSBootstrapClientService = "linux/cloud-init/artifacts/download-secure-tls-bootstrap-client.service"
