...
- For Linux, the cni-plugins, azure-cni, cri-tools are not onboarded for auto-update yet. The team has been working on this. cri-tools package will soon be available, then cni-plugins and azure-cni.
