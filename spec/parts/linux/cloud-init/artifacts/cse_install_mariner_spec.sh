...
Describe 'cse_install_mariner.sh'
    ...
    Describe 'should_use_nvidia_open_drivers'
        ...
        # Uses mocked IMDS_INSTANCE_METADATA_CACHE_FILE to provide VM SKU
        imds_mock_dir="$PWD/spec/parts/linux/cloud-init/artifacts/imds_mocks/gpu"

        setup_imds_mock() {
            mkdir -p "$imds_mock_dir"
        }
