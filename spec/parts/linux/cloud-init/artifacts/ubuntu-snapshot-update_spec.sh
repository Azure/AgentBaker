...
EOF
    ...
    It 'should update successfully for ni cluster'
        ...
        End
        sources_list=$(cat <<EOF
deb http://10.0.0.1/ubuntu/20250825T000000Z noble main restricted
deb http://10.0.0.1/ubuntu/20250825T000000Z noble-updates main restricted
deb http://10.0.0.1/ubuntu/20250825T000000Z noble universe
deb http://10.0.0.1/ubuntu/20250825T000000Z noble-updates universe
deb http://10.0.0.1/ubuntu/20250825T000000Z noble multiverse
deb http://10.0.0.1/ubuntu/20250825T000000Z noble-updates multiverse
deb http://10.0.0.1/ubuntu/20250825T000000Z noble-backports main restricted universe multiverse
deb http://10.0.0.1/ubuntu/20250825T000000Z noble-security main restricted
deb http://10.0.0.1/ubuntu/20250825T000000Z noble-security universe
deb http://10.0.0.1/ubuntu/20250825T000000Z noble-security multiverse
EOF
)
        apt_config=$(cat <<EOF
Dir::Etc::sourcelist "${SECURITY_PATCH_CONFIG_DIR}/sources.list";
