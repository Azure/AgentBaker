...
EOF
    ...
    It 'should reject a malformed golden timestamp and not generate apt sources'
        Mock kubectl
    ...
    It 'should reject a newline-bearing golden timestamp used to inject apt sources'
        Mock kubectl
